...
public class UM5UpdateAttributes extends RestService {

	@GET
	public Response getInfos(@Context HttpServletRequest request, @QueryParam("oids") String oids, @QueryParam("attrSelect") String attrSelect, @DefaultValue("") @QueryParam("newValue") String newValue) throws UM5RestServiceException{
		return infos(request, oids, attrSelect, newValue);
	}
	
	@POST
	public Response postInfos(@Context HttpServletRequest request, @FormParam("oids") String oids, @FormParam("attrSelect") String attrSelect, @DefaultValue("") @FormParam("newValue") String newValue) throws UM5RestServiceException{
		return infos(request, oids, attrSelect, newValue);
	}
	
	public Response infos(HttpServletRequest request, String oids, String attrSelect, String newValue) throws UM5RestServiceException{
