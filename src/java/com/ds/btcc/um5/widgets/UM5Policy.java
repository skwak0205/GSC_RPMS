...
@Path("/Policy")
public class UM5Policy extends RestService {
	...
	public Response list(HttpServletRequest request, String namePattern, String where) throws UM5RestServiceException {
	...
	public Response getPolicyInfos(@Context HttpServletRequest request, @PathParam("policyName") String policyName) throws UM5RestServiceException {
		return policyInfos(request, policyName);
	}

	@POST
	@Path("/{policyName}/infos")
	public Response postPolicyInfos(@Context HttpServletRequest request, @PathParam("policyName") String policyName) throws UM5RestServiceException {
		return policyInfos(request, policyName);
	}

	public Response policyInfos(HttpServletRequest request, String policyName) throws UM5RestServiceException {
		JsonObjectBuilder output = Json.createObjectBuilder();
