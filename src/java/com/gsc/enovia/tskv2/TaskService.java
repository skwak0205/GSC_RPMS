...
public class TaskService implements ServiceConstants {
    ...
    public static Datacollection updateTasks(Context var0, String[] var1) throws FoundationException {
        ...
        List var6 = Task.getTaskTypes(var0);
        ...
        while(true) {
                    ...
                    if (var14 != null) {
                        ...
                        while(var19.hasNext()) {
                            ...
                            if ("True".equalsIgnoreCase(var52) && UpdateActions.CREATE.equals(var20.getUpdateAction())) {
                                Task.modifyTask(var0, var50, var9, false, true, false, (String)null);
                                var3.put("rollup", "live");
                            } else {
                                Task.modifyTask(var0, var50, var9, false, false);
                            }

                            var23 = DataelementMapAdapter.getDataelementValue(var20, "state");
                            if (var23 != null && !var23.equals("Create")) {
                                Task.setTaskState(var0, var50, var23, var20.getType(), var5);
                            }
                        }
                            ...
                            do {
                                    ...
                                    while(true) {
                                        while(var70.hasNext()) {
                                            ...
                                            if (UpdateActions.MODIFY.equals(var83)) {
                                                ...
                                                Task.modifyTask(var0, var73, var9, var94, !var35, var93, var5);
                                ...
                                if (!UpdateActions.CONNECT.equals(var62) && !UpdateActions.DISCONNECT.equals(var62)) {
                                    if (UpdateActions.MODIFY.equals(var62)) {
                                        ...
                                        Dataobject var77 = Task.deleteTask(var0, var60, var54.getParent() == null, var72);
                                        if (var77 != null) {
                                    ...
                                    if (UpdateActions.DISCONNECT.equals(var62)) {
                                        Task.removeSubtask(var0, var26, var67, var72);
                                    } else {
                                        var54.setUpdateAction(UpdateActions.MODIFY);
                                        var67 = ServiceSave.getActualIdForTempId(var0, var67);
                                        var54.setId(var67);
                                        var73 = Task.modifySubtask(var0, var26, var67, (Map)null, var72);
            ...
            if (var22 != null) {
                if (var14 == null) {
                    ...
                    var24.add(Task.SELECTABLE_DEFAULT_CONSTRAINT_TYPE);
                    var24.add(Task.SELECTABLE_TASK_CONSTRAINT_TYPE);
                    var25 = Task.getTaskInfo(var0, var22.getId(), var24);
                    var14 = DataelementMapAdapter.getDataelementValue(var25, Task.SELECT_TASK_ESTIMATED_START_DATE.getName());
                    var26 = var25.getType();
                    var22.setType(var26);
            ...
            if (var6.indexOf(var57) == -1) {
                ...
                var26 = Task.addSubtask(var0, (String)null, var22.getId(), var22.getType(), var20.getId(), (Map)null);
                ...
                var73 = Task.createTask(var0, var57, var60, var9, var67, var71);
                ...
                if (var22 != null) {
                    ...
                    var33 = Task.addSubtask(var0, var30, var22.getId(), var22.getType(), var73, var32);
    ...
    private static void handleDuration(Context var0, Dataobject var1, Map<String, String> var2, UpdateActions var3) throws FoundationException {
        ...
        if (var4 != null && !var4.isEmpty() || var5 != null && !var5.isEmpty()) {
            ...
            if (UpdateActions.MODIFY.equals(var3)) {
                ...
                if (!var7.isEmpty()) {
                    Dataobject var8 = Task.getTaskInfo(var0, var1.getId(), var7);
            ...
            if (var6 != null && !var6.isEmpty() && var5 != null && !var5.isEmpty()) {
                if (!UpdateActions.CREATE.equals(var3)) {
                    String var11 = Task.getPALId(var0, var1.getId());
                    if (var11.isEmpty()) {
    ...
    private static void handleActuals(Dataobject var0, Map<String, String> var1, String var2) {
        if (var2 == null || !var2.contains("dpm.projecttemplates")) {
            ...
            String var5 = DataelementMapAdapter.getDataelementValue(var0, Task.SELECT_TASK_ACTUAL_START_DATE.getName());
    ...
    private static String getTaskPALIdToConnect(Context var0, Dataobject var1, Dataobject var2) throws FoundationException {
        ...
        String var5 = var4 != null ? var4 : Task.getPALId(var0, var1.getId());
    ...
    private static void handleDefaultConstraintType(Context var0, Dataobject var1, Dataobject var2, Map<String, String> var3) throws FoundationException {
        if (var1 != null) {
            ...
            String var6 = var5 != null ? var5 : Task.getDefaultConstraintType(var0, var1.getId());
    ...
    public static Datacollection updatePredecessors(Context var0, String[] var1) throws FoundationException {
        ...
        while(var6.hasNext()) {
            ...
            var11.add(Task.SELECTABLE_ISPROJECTSPACE);
            var11.add(Task.SELECTABLE_ISPROJECTCONCEPT);
            Dataobject var12 = Task.getTaskInfo(var0, var9, var11);
            boolean var13 = "TRUE".equalsIgnoreCase(DataelementMapAdapter.getDataelementValue(var12, Task.SELECTABLE_ISPROJECTSPACE.getName())) || "TRUE".equalsIgnoreCase(DataelementMapAdapter.getDataelementValue(var12, Task.SELECTABLE_ISPROJECTCONCEPT.getName()));
            if (var13) {
                ...
                while(var28.hasNext()) {
                    ...
                    if (!UpdateActions.CREATE.equals(var38) && !UpdateActions.CONNECT.equals(var38)) {
                        if (UpdateActions.MODIFY.equals(var38)) {
                            var17 = var8.getRelId();
                            if (var17 != null) {
                                Task.modifyPredecessorId(var0, var17, var26);
                            } else {
                                var18 = Task.modifyPredecessor(var0, var33, var8.getId(), var26);
                                var8.setRelId(var18);
                            }
                            ...
                            if (var17 != null) {
                                ...
                                Task.deletePredecessor(var0, var33, var8.getId());
                            }
                        ...
                        if (var19 != null && !var19.isEmpty()) {
                            Task.modifyPredecessorId(var0, var19, var26);
                        } else {
                            var8.setId(var17);
                            String var39 = Task.addPredecessor(var0, var33, var17, var26);
                            var8.setRelId(var39);
                        }
                    }
                }
    ...
    public static Dataobject updateTaskAssignees(Context var0, String[] var1) throws FoundationException {
        ServiceParameters var2 = (ServiceParameters)JPOUtil.unpackArgs(var1);
        ...
        String var6 = var3.getParent().getId();
        Dataobject var7 = getTaskInfo(var0, var6);
        ...
        if (var11 == null) {
            ...
            if (var13 != null && !var13.isEmpty()) {
                ...
                var15 = Task.getPersonInfo(var0, var13, var14, 1);
                if (var15.getDataobjects().isEmpty()) {
                    String var21 = PropertyUtil.getTranslatedValue(var0, "CollaborativeTasks", "emxCollaborativeTasks.Error.AssigneeInvalid", var0.getLocale());
        ...
        if (UpdateActions.CONNECT.equals(var4) || UpdateActions.CREATE.equals(var4) || UpdateActions.MODIFY.equals(var4)) {
            ...
            if ("Inbox Task".equals(var8)) {
                Task.setRouteTaskAssignee(var0, var6, var11);
            } else {
                ...
                if (UpdateActions.MODIFY.equals(var4)) {
                    var15 = null;
                    if (var12 != null) {
                        var20 = ObjectEditUtil.modifyConnection(var0, var12, var17, true, "id");
                    } else {
                        var20 = AssignedTasks.modifyTaskAssignee(var0, var6, var11, var17);
                    }

                    var3.setRelId(var20);
                } else {
                    var20 = AssignedTasks.addTaskAssignee(var0, var6, var11, var17, var10);
                    var3.setRelId(var20);
                }
            }
            ...
            ServiceSave.getUpdatedObjects(var0, var2.getServiceReferenceName(), var2, var13);
        ...
        if (UpdateActions.DISCONNECT.equals(var4) || UpdateActions.DELETE.equals(var4)) {
            if ("Inbox Task".equals(var8)) {
                ...
                ObjectEditUtil.disconnect(var0, var12);
            } else {
                AssignedTasks.removeTaskAssignee(var0, var6, var11, var10);
            }
        }
    ...
    private static Dataobject getTaskInfo(Context var0, String var1) throws FoundationException {
        ...
        Dataobject var3 = Task.getTaskInfo(var0, var1, var2);
        return var3;
    }
    ...
    public static Dataobject updateProjectScope(Context var0, String[] var1) throws FoundationException {
        ServiceParameters var2 = (ServiceParameters)JPOUtil.unpackArgs(var1);
        Datacollection var3 = var2.getDatacollection();
        Dataobject var4 = (Dataobject)var3.getDataobjects().get(0);
        UpdateActions var5 = var4.getUpdateAction();
        ...
        if (UpdateActions.CONNECT.equals(var5) || UpdateActions.CREATE.equals(var5)) {
            ...
            var8.add(Task.SELECT_TASK_ESTIMATED_DURATION_INPUT_VALUE);
            Dataobject var9 = Task.getTaskInfo(var0, var7, var8);
            String var10 = DataelementMapAdapter.getDataelementValue(var9, Task.SELECT_TASK_ESTIMATED_DURATION_INPUT_VALUE.getName());
            ensureValidTaskDuration(var0, var10);
            String var11 = var4.getId();
            TaskScope.addTaskToProjectScope(var0, var7, var11, (Map)null);
    ...
    public static Dataobject updateCalendar(Context var0, String[] var1) throws FoundationException {
        ...
        if (UpdateActions.CONNECT.equals(var6) || UpdateActions.CREATE.equals(var6) || UpdateActions.MODIFY.equals(var6)) {
            Task.setCalendar(var0, var7, var9, var5);
        ...
        if (UpdateActions.DISCONNECT.equals(var6) || UpdateActions.DELETE.equals(var6)) {
            Task.removeCalendar(var0, var7, var9, var5);
        }
    ...
    public static Datacollection getTasks(Context var0, String[] var1) throws FoundationException {
        ServiceParameters var2 = (ServiceParameters)JPOUtil.unpackArgs(var1);
        return getTasks(var0, var2);
    }

    public static Datacollection getTasks(Context context, ServiceParameters serviceParameters) throws FoundationException {
        HttpServletRequest httpRequest = serviceParameters.getHttpRequest();
        Task.checkLicenseCollaborativeTasks(context, httpRequest);
        Datacollection datacollection1 = serviceParameters.getDatacollection();
        List selects = serviceParameters.getSelects();
        ArgMap serviceArgs = serviceParameters.getServiceArgs();
        String showProjectTasks = (String)serviceArgs.get("showProjectTasks");
        String scopeId = (String)serviceArgs.get("scopeId");
        String deliverableId = (String)serviceArgs.get("deliverableId");
        String referenceId = (String)serviceArgs.get("referenceId");
        boolean isShowProjectTasks = Boolean.parseBoolean(showProjectTasks);
        String currentTaskFilter = (String)serviceArgs.get("currentTaskFilter");
        String fromCompletionDate = (String)serviceArgs.get("fromCompletionDate");
        String includeRouteTasks = (String)serviceParameters.getJpoArgs().get("includeRouteTasks");
        String includeRouteTasks1 = (String)serviceArgs.get("includeRouteTasks");
        String state = (String)serviceArgs.get("state");
        String completionDate = null;
        if (fromCompletionDate != null && !fromCompletionDate.equalsIgnoreCase("all")) {
            Date var16 = FormatUtil.parseISODate(context, fromCompletionDate, (SimpleDateFormat)null);
            completionDate = FormatUtil.formatMxDate(context, var16, (SimpleDateFormat)null);
        }

        Datacollection datacollection = datacollection1;
        if (datacollection1 != null && !datacollection1.getDataobjects().isEmpty()) {
            Task.getTaskInfo(context, datacollection1, selects);
        } else if (scopeId != null && !"".equals(scopeId)) {
            ArrayList arrayList = new ArrayList();
            Select select = new Select("type", "type", ExpressionType.BUS, (Format)null, false);
            arrayList.add(select);
            arrayList.add(Task.SELECTABLE_ISPROJECTSPACE);
            Dataobject var25 = ObjectUtil.print(context, scopeId, (PrintData)null, arrayList);
            String var27 = DataelementMapAdapter.getDataelementValue(var25, Task.SELECTABLE_ISPROJECTSPACE.getName());
            if ("TRUE".equalsIgnoreCase(var27)) {
                datacollection = TaskScope.getProjectScopeTasks(context, scopeId, selects, currentTaskFilter, completionDate);
            } else {
                datacollection = TaskScope.getScopeTasks(context, scopeId, selects, currentTaskFilter, completionDate);
            }
        } else if (deliverableId != null && !deliverableId.isEmpty()) {
            datacollection = TaskReferences.getRelatedTasks(context, "deliverable", deliverableId, selects);
        } else if (referenceId != null && !referenceId.isEmpty()) {
            datacollection = TaskReferences.getRelatedTasks(context, "reference", referenceId, selects);
        } else {
            String var17 = null;
            if (isShowProjectTasks) {
                try {
                    Task.checkLicenseProjectTasks(context, httpRequest);
                } catch (Exception var21) {
                    isShowProjectTasks = false;
                    var17 = "User: " + context.getUser() + " has no access to product: DPM";
                    System.out.println(var17);
                }
            }

            String createSampleData = (String)serviceArgs.get("createSampleData");
            String var19 = null;
            if ("TRUE".equalsIgnoreCase(createSampleData)) {
                boolean var20 = generateSampleData(context);
                var19 = var20 ? null : "Unable to create sample data for user, likely due to permission issues.";
            }

            datacollection = Task.getUserTasks(context, selects, currentTaskFilter, isShowProjectTasks, completionDate,state);
            if ("TRUE".equalsIgnoreCase(includeRouteTasks) || "TRUE".equalsIgnoreCase(includeRouteTasks1)) {
                Datacollection var26 = Task.getUserRouteInboxTasks(context, selects, completionDate);
                datacollection.getDataobjects().addAll(var26.getDataobjects());
            }

            ServiceBase.appendInfoMessage(datacollection, var17);
            ServiceBase.appendInfoMessage(datacollection, var19);
        }
    ...
    public static Datacollections getCalendar(Context var0, String[] var1) throws FoundationException {
        ...
        Datacollections var5 = Task.getCalendar(var0, var3, var4);
        return var5;
    }
    ...
    public static Range getRangeTaskTypes(Context var0, String[] var1) throws FoundationException {
        List var2 = Task.getTaskTypes(var0);
    ...
    public Datacollection getPerson(Context var1, String[] var2) throws FoundationException {
        ...
        List var18 = Task.getPersonInfo(var1, var17, var5, 0).getDataobjects();
    ...
    public static Range getStates(Context var0, String[] var1) throws FoundationException {
        ...
        Range var6 = Task.getStates(var0, var4);
        ...
        if ("Project Space Hold Cancel".equals(var7)) {
            Range var10 = Task.getStates(var0, var7);
    ...
    public static Dataobject updateTaskAssignNotificationPreference(Context var0, String[] var1) throws FoundationException {
        ...
        if (UpdateActions.MODIFY.equals(var6)) {
            ...
            Task.setTaskAssignNotificationPreference(var0, new Boolean(var7));
        }
    ...
    private static boolean generateSampleData(Context var0) throws FoundationException {
        boolean var1 = true;
        String var2 = ContextUtil.getPersonProperty(var0, "preference_SampleDataCreated");
        if ("TRUE".equalsIgnoreCase(var2)) {
            return var1;
        } else {
            ContextUtil.setSavePoint(var0, "sample_data");

            try {
                ArrayList var3 = new ArrayList(1);
                Select var4 = new Select("physicalid", "physicalid", ExpressionType.BUS, (Format)null, false);
                var3.add(var4);
                Datacollection var5 = Task.getPersonInfo(var0, var0.getUser(), var3, 1);
                String var6 = ((Dataobject)var5.getDataobjects().get(0)).getId();
                Date var7 = new Date();
                String var8 = "emxCollaborativeTasks.SampleData.Task1.name";
                String var9 = "emxCollaborativeTasks.SampleData.Task1.description";
                String var10 = "5";
                createSampleTask(var0, var8, var9, var10, var7, var6);
                Date var11 = FormatUtil.computeDate(1);
                var8 = "emxCollaborativeTasks.SampleData.Task2.name";
                var9 = "emxCollaborativeTasks.SampleData.Task2.description";
                var10 = "2";
                createSampleTask(var0, var8, var9, var10, var11, var6);
                Date var12 = FormatUtil.computeDate(3);
                var8 = "emxCollaborativeTasks.SampleData.Task3.name";
                var9 = "emxCollaborativeTasks.SampleData.Task3.description";
                var10 = "3";
                createSampleTask(var0, var8, var9, var10, var12, var6);
                ContextUtil.setPersonProperty(var0, "preference_SampleDataCreated", "TRUE");
            } catch (Exception var13) {
                ContextUtil.abortSavePoint(var0, "sample_data");
                var1 = false;
    ...
    private static void createSampleTask(Context var0, String var1, String var2, String var3, Date var4, String var5) throws FoundationException {
        String var6 = PropertyUtil.getTranslatedValue(var0, "CollaborativeTasks", var1, var0.getLocale());
        String var7 = PropertyUtil.getTranslatedValue(var0, "CollaborativeTasks", var2, var0.getLocale());
        String var8 = FormatUtil.formatMxDate(var0, var4, (SimpleDateFormat)null);
        HashMap var9 = new HashMap();
        var9.put("description", var7);
        var9.put("Task Estimated Duration", var3);
        var9.put("Task Estimated Finish Date", var8);
        String var10 = Task.createTask(var0, var6, var9);
        AssignedTasks.addTaskAssignee(var0, var10, var5, (Map)null);
        String var11 = var0.getUser() + "_PRJ";
        MqlUtil.mqlCommand(var0, "modify bus $1 add ownership $2 $3 for $4 as $5", new String[]{var10, "-", var11, "Multiple Ownership For Object", "delete"});
    }
    ...
    private static void handleFormatPattern(Context var0, Dataobject var1, Map<String, String> var2, UpdateActions var3) throws FoundationException {
        ...
        if (var4 != null && !var4.isEmpty()) {
            ...
            if (UpdateActions.MODIFY.equals(var3)) {
                ...
                Dataobject var9 = Task.getTaskInfo(var0, var6, var8);
    ...
    public static Datacollections getCoOwners(Context context, String[] args) throws FoundationException {
        ...
        List selects = serviceParameters.getSelects();
        System.out.println("datacollection : " + datacollection.getSummary() + " , selects : " + selects);

        datacollection.getDataobjects().parallelStream().forEach(obj -> {
            System.out.println("identifier : " + obj.getIdentifier());
        });
        Datacollections coOwners = Task.getCoOwners(context, datacollection, selects);
        return coOwners;
    }
        ...
        while(true) {
            ...
            do {
                while(var4.hasNext()) {
                    ...
                    Dataobject var11 = Task.addCoOwner(var0, var8, var9, var10);
            ...
            Task.removeCoOwner(var0, var8, var9, var10);
