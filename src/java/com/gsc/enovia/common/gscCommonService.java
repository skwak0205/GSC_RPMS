...
public class gscCommonService implements ServiceConstants {

    public static Datacollection getCommonInfos(Context context, String[] args) throws FoundationException {
        ...
        String var14 = String.format("%s%s (%d) ...\t", ">>> PROGRAM (SVC):  ", "getCommons", datacollection1.getDataobjects().size());
