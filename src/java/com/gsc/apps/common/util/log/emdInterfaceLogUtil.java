/**
 * <pre>
 * Interface Log Util Class
 * </pre>
 *
 * @ClassName   : emdInterfaceLogUtil.java
 * @Description : Interface Log Util Class
 * @author      : BongJun,Park
 * @since       : 2020-10-22
 * @version     : 1.0
 * @see
...
public class emdInterfaceLogUtil implements emdILogUtil {
    private static Logger log = LoggerFactory.getLogger("INTERFACE_LOG");
