...
public class emxSortPersonFullNameCloudBase_mxJPO extends emxCommonBaseComparator_mxJPO
{
    private Context context;
   
    /**
     * emxSortPersonFullName3dswymCloudBase JPO Constructor
     * @param context
     * @param args
     * @throws Exception
     */
    public emxSortPersonFullNameCloudBase_mxJPO (Context context, String[] args)
        throws Exception
    {
    ...
    public emxSortPersonFullNameCloudBase_mxJPO ()
    {
        try {
