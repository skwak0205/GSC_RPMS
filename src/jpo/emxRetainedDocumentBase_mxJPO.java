...
public Vector getImageObject(Context context,String[] args) throws Exception
    {
        ...
        StringList resultSelectsMultiVal = new StringList();
        ...
        resultSelectsMultiVal.add(selectKey_RType);
        resultSelectsMultiVal.add(selectKey_RDate);
        //MULTI_VALUE_LIST.add(selectKey_RType);
        //MULTI_VALUE_LIST.add(selectKey_RDate);
        
        MapList results = DomainObject.getInfo(context, objectIds, resultSelects, resultSelectsMultiVal);
        ...
        while(itr.hasNext()){
            ...
            if(purged){
                ...
                if(retentionHold){
                    imageTag.append("<img border=\"0\" src=\"../common/images/iconStatusObjectHold.gif\" name=\"morethanone\" id=\"morethanone\" alt=\"more than one\" title=\""+sConnectedToHolds+"\"></img>"); //IR-874725-3DEXPERIENCER2022x
                }
            }
     ...
     public StringList isNotPurgedRecord (Context context,String [] args) throws Exception {
         ...
         while(itr.hasNext()){
        	 ...
        	 if(type!=null && type.equals(type_PurgedRecord)){
            	 ...
            	 rtnStr.add(Boolean.toString(bool));
        	 }else{
