...
public MapList getModelMilestones(Context context,String strModelMTId) {
 ...
 public StringList isDisciplineEditallowed(Context context,String args[])
 {
	 ...
	 try {
		 ...
		 boolean isConfManager = PersonUtil.getAssignmentsForDisplay(context).contains(strConfigurationManager); // replaced method getAssignments with getAssignmentsForDisplay to return title instead of name.
...
//				 slEditable.add(bEditable);
				 slEditable.add(String.valueOf(bEditable));
			 }
			 else{
//				 slEditable.add(bEditable);
				 slEditable.add(String.valueOf(bEditable));
