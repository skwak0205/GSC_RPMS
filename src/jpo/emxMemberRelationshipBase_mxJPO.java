        ...
        if(Boolean.valueOf(isKindOfProjectTemplate)){
            ...
            if(collabspacesMap!=null){
            	  ...
            	  for (int j=0; j < collabListLen; j++) {
					  ...
					  String assignment = "assignment[ctx::"+ leader+ "."+ name +"]";
					  
					  String assignedRoles = MqlUtil.mqlCommand(context, "print person $1 select $2 dump", true, personName, assignment);
					  
					  if("true".equalsIgnoreCase(assignedRoles) && ("All".equalsIgnoreCase(memberAccess) || "Project Lead".equalsIgnoreCase(memberAccess))){
					  	access = "Project Lead";
					  	break;
					  }
            	  }
