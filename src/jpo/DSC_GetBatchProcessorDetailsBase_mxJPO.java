...
public class DSC_GetBatchProcessorDetailsBase_mxJPO 
{
    ...
    {		
		...
		Hashtable siteNameSiteDetailsTableDO = new Hashtable();
		Hashtable siteNameSiteDetailsTableRename = new Hashtable();
		Hashtable siteNameSiteDetailsTableUpdateStruct = new Hashtable();
		...
		*/
		...
		/*Every Queue name in one specific batch operation should have unique site name.
		Site name can be same across different operations.
        */
		/*
		For the specific operation respective code must be uncommented.
		*/
	    ...
	    siteNameSiteDetailsTableDO.put("<SITE1>", site1Details);*/
	...
	/*	Hashtable site2Details = new Hashtable();
        ...
        siteNameSiteDetailsTableRename.put("<SITE2>", site2Details);*/

		//Update Structure Operation
		Hashtable site3Details = new Hashtable();
		site3Details.put(SHADOW_USER_NAME, "");
		site3Details.put(SHADOW_USER_PASSWORD, "");
		site3Details.put(QUEUE_NAME, "UpdateStructureQueue");
		
		siteNameSiteDetailsTableUpdateStruct.put("<SITE3>", site3Details);
		
	
		updateStructureOperationDetails.put(SITE_DETAILS_TABLE, siteNameSiteDetailsTableUpdateStruct);
		batchOperationDetails.put("BackgroundUpdateStructure", updateStructureOperationDetails);
		
		renameOperationDetails.put(SITE_DETAILS_TABLE, siteNameSiteDetailsTableRename);
		batchOperationDetails.put("BatchRename", renameOperationDetails);

		derivedOutputOperationDetails.put(SITE_DETAILS_TABLE, siteNameSiteDetailsTableDO);		
