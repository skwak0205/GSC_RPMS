...
{ 
        ...
        throws Exception
    {
        ...
        // Search Role
        //
        String strResult = MqlUtil.mqlCommand(context, "list role $1", true, strFilter);
        ...
        // Search Group
        //
        strResult = MqlUtil.mqlCommand(context, "list group $1", true, strFilter);
        ...
        strResult = MqlUtil.mqlCommand(context, "temp query bus $1 $2 $3", true,typeProxyGroup, strFilter,"-");
        slResult = FrameworkUtil.split(strResult, "\n");
        String[] tempArray = new String[3];
        for (StringItr stringItr = new StringItr(slResult); stringItr.next();) {
            strName = stringItr.obj();
            tempArray = strName.split(" ");
            addValue(tempArray[1], "UserGroup");
        }
