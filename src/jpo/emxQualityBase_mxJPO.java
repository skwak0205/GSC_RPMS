...
//            if ("Controlled".equalsIgnoreCase((String)map.get(QualityMetricRelationship.SELECT_METRIC_SOURCE))){
//            	map.put("RowEditable", "readonly");
//            }
            if("Initiated".equalsIgnoreCase(strQualityState)){
	       		 if( !("GOAL".equalsIgnoreCase((String)map.get(QualityMetricRelationship.SELECT_METRIC_SOURCE)) ) ) {
	       			 map.put("RowEditable", "readonly");
	       		 }
	         }else {
	        	 map.put("RowEditable", "readonly");
        ...
        if(null != (strQualityState) && !"".equals(strQualityState) && !"Controlled".equals(strQualityState) && MetricList.size() > 0) {
        	...
        	mpLatestQualityMetric.remove("RowEditable", "readonly");
        }
       return MetricList;
    }
