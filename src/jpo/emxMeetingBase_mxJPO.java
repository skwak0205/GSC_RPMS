      ...
      //While exporting mode is empty and reportFormat ="CSV".
        ...
        if("create".equals(strMode)){
        	...
        	if((DomainObject.TYPE_WORKSPACE).equals(meetingMap.get(DomainConstants.SELECT_TYPE)) ||
        			com.matrixone.apps.domain.util.mxType.isOfParentType(context,(String)meetingMap.get(DomainConstants.SELECT_TYPE),com.matrixone.apps.domain.DomainObject.TYPE_WORKSPACE_VAULT)) {
