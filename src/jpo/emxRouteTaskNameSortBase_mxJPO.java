...
public class emxRouteTaskNameSortBase_mxJPO extends emxCommonBaseComparator_mxJPO
{
     ...
     * @throws Exception
     */
    public emxRouteTaskNameSortBase_mxJPO (Context context, String[] args)
        throws Exception
    {
    ...
    public emxRouteTaskNameSortBase_mxJPO ()
    {
        try {
    ...
    public int compare (Object object1,Object object2) 
    {
      ...
      //  String htmlOutPutDisplayKey = keyName.toLowerCase();
        String stringValue1 = (String) map1.get("name"); 
      //  stringValue1 = !(stringValue1 == null) ? stringValue1 : (String) map1.get(keyName);
        String stringValue2 = (String) map2.get("name");
       // stringValue2 = !(stringValue2 == null) ? stringValue2 : (String) map2.get(keyName);
        
        if("Route Node".equals(stringValue2) && "Route Node".equals(stringValue1)) {
        	stringValue1 = (String) map1.get("attribute[Title]"); 
        	stringValue2 = (String) map2.get("attribute[Title]"); 
        }
