...
20-03-17   KIE1 ZUD   V62018x   IR-508318-3DEXPERIENCER2018x : Requirement: In Test Execution Assignee list, Two icons are displayed for a single person/assignee.
    ...
    public Vector getCompleteName (Context context, String[] args) throws Exception {
        ...
        for (int i = 0; i < iNoOfObjects; i++) {
            ...
            else
            {
            	...
            	// removed the extra used person image another used in business table column
