 ...
 * @quickreview KIE1 ZUD 01:23:19 		IR-658231-3DEXPERIENCER2019x: Search within context shows wrong types and count for 6Wtags
 */
	...
	public static StringList getContextObjects(final Context context, final String[] args) throws Exception
	{
		...
		if((selectedProgram == null) ||("".equals(selectedProgram)))
		{
			...
			String relationshipPattern = PropertyUtil.getSchemaProperty(context, ReqConstants.SYMBOLIC_RELATIONSHIP_SPECIFICATION_STRUCTURE) + "," +
					...
					PropertyUtil.getSchemaProperty(context, ReqConstants.SYMBOLIC_PARAMETER_AGGREGATION_RELATIONSHIP)+ "," +
					PropertyUtil.getSchemaProperty(context, SYMBOLIC_relationship_RequirementValidation);
			...
			+","+ReqSchemaUtil.getTestCaseType(context)+","+ReqSchemaUtil.getParameterType(context)+","+ReqSchemaUtil.getCommentType(context);
