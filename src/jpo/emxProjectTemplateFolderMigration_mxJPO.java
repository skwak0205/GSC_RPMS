...
//
public class emxProjectTemplateFolderMigration_mxJPO extends emxProjectTemplateFolderMigrationBase_mxJPO {

    public emxProjectTemplateFolderMigration_mxJPO(Context context, String[] args)
            throws Exception
    {
        super(context, args);
    }
