 ...
 public class emxAPPQuickFileBase_mxJPO{
    ...
    */
                        ...
                        String[] args )throws Exception
    {
        ...
        // Tokenize and add to rel pattern

        if(UIUtil.isNotNullAndNotEmpty(strRelName)) {
            ...
            while(relString.hasMoreTokens()) {
                ...
                if(UIUtil.isNotNullAndNotEmpty(relStr)) {
                    ...
                    while (matcher.find()) {
                        ...
                        if("relationship_".indexOf(strMatch) != -1) {
                            ...
                            if(UIUtil.isNotNullAndNotEmpty(actRelName)) {
        ...
        if(UIUtil.isNullOrEmpty(relPattern.getPattern())) {
        ...
        MapList documents = masterObject.getRelatedObjects(context, relPattern.getPattern(), "*", typeSelects, relSelects, true, true, (short)1, objectWhere, null, (short)0);
        ...
        settings.put("Registered Suite","Components");
      //datagrid
        if (paramMap.containsKey("isGrid")) {
        	String isGrid = (String) paramMap.get("isGrid");
        	if (isGrid.equals("true"))
        		settings.put("Image","iconSmallDocument.gif"); 
			else
    ...
    */
                        ...
                        String[] args )throws Exception
    {
        ...
        if (paramMap.containsKey("isGrid")) {
        	String isGrid = (String) paramMap.get("isGrid");
        	if (isGrid.equals("true"))
        		commandMap.put("href","../common/emxDynamicAttributes.jsp?objectId="+strObjId+"&isGrid=true&isFromGridRMBMenu=true"); 
			else
        ...
        */
            ...
            String[] args )throws Exception
        {
          ...
          //datagrid
			String strURL = "";
			if (paramMap.containsKey("isGrid")) {
				strURL = "../common/emxTable.jsp?program=emxQuickFileAccess:getQuickFileObjects&table=APPQuickFileSummary&sortColumnName=ContainedIn&emxSuiteDirectory=components&suiteKey=Components&sortDirection=ascending&header=emxComponents.Common.FileDetails&CancelButton=true&CancelLabel=emxComponents.Button.Close&HelpMarker=emxhelpquickfileview&FilterFramePage=../components/emxCommonDocumentCheckoutUtil.jsp&FilterFrameSize=1&isGrid=true";
			}
			else {
            ...
            sbfItem.append(XSSUtil.encodeForJavaScript(context,sRelation));
