...
public class emxLibraryCentralGenericDocumentAccessMigrationFindObjectsBase_mxJPO extends emxCommonFindObjects_mxJPO
{
	String genericDocType = "";
	String defaultChunkSize = "100";

	public emxLibraryCentralGenericDocumentAccessMigrationFindObjectsBase_mxJPO(Context context, String[] args) throws Exception 
	{
		super(context, args);
    ...
    public void getIds(Context context, int chunkSize) throws Exception
    {
        ...
        try
        {
            ...
            MqlUtil.mqlCommand(context, command, genericDocType, name, revision, vaultList, "1", "policy!=Version && to[Classified Item]==TRUE && attribute[Access Type]==Inherited && program[" + migrationProgramName + " -method writeOID ${OBJECTID} \"${TYPE}\"] == true");
        }
        catch(Exception me)
        {
            throw me;
