        ...
        try
        {
            ...
            for(int i = 0; i < stringlist.size(); i++)
            {
                try
                {
                    ...
                    if(!sString5.equals("") && !sString5.equals("*"))
                    {
                        ...
                        {
                            String s52 = eMatrixDateFormat.getFormattedInputDateTime(context, sString5, "12:00:00 AM", iDateFormat, timeZone, locale);
                            String s54 = eMatrixDateFormat.getFormattedInputDateTime(context, sString5, "11:59:59 PM", iDateFormat, timeZone, locale);
                            stringbuffer1.append(sLessThanOrEqualConst);
                            stringbuffer1.append(sBackSlash);
                        ...
                        {
                            sString5 = eMatrixDateFormat.getFormattedInputDateTime(context, sString5, "11:59:59 PM", iDateFormat, timeZone, locale);
                            stringbuffer1.append(sLessThanOrEqualConst);
                            stringbuffer1.append(sBackSlash);
                            stringbuffer1.append(sString5);
                            stringbuffer1.append(sBackSlash);
                        ...
                        {
                            sString5 = eMatrixDateFormat.getFormattedInputDateTime(context, sString5, "12:00:00 AM", iDateFormat, timeZone, locale);
                            stringbuffer1.append(sGreaterThanOrEqualConst);
                            stringbuffer1.append(sBackSlash);
                            stringbuffer1.append(sString5);
                            stringbuffer1.append(sBackSlash);
            ...
            try
            {
                if(dateCreatedAfter != null && dateCreatedAfter.length() != 0)
                {
                	...
                	{
                    dateString = eMatrixDateFormat.getFormattedInputDateTime(context, dateCreatedAfter, "12:00:00 AM", iDateFormat, timeZone, locale);
                	}
                	else
                	{
            ...
            try
            {
                if(dateCreatedBefore != null && dateCreatedBefore.length() != 0)
                {
                	if(datetimepattern == null)
                	{
                    dateString = eMatrixDateFormat.getFormattedInputDateTime(context, dateCreatedBefore, "12:00:00 AM", iDateFormat, timeZone, locale);
                	}
                	else
                	{
	...
	public String getAllTypes(Context context, String[] args) throws Exception
    {
        ...
        try
        {
            ...
            if(_util != null)
            {
                ...
                {
				sDefaultRootTypeListFromGCO = MCADMxUtil.getActualNameForAEFData(context, rootType);
                }
                else
                {
                    sDefaultRootTypeListFromGCO = "Office Document";
                }
            }
            ...
            {
                String eachType=typeListTokenizer.nextToken().trim();
                BusinessType busType = new BusinessType(eachType, context.getVault());
                rootLevelTypes.addElement(busType);
            }
