...
public class emxObjectAccessBase_mxJPO extends emxDomainObject_mxJPO
{
    ...
    */
        ...
        throws Exception
    {
        ...
        for (int k=0; k < objList.size(); k++)
        {
            ...
            if("false".equalsIgnoreCase(editMode) && type.equalsIgnoreCase("Person"))
            {
                ...
                strBuffName.append("<img src=\"../common/images/iconSmallPerson.png\" border=\"0\"/>&nbsp;");
        ...
        throws Exception
    {
		...
		String Librarian = PropertyUtil.getSchemaProperty(context,"role_Librarian");
		if(Librarian != null && Librarian.length() > 0){
			isLibrarian = personObj.isAssigned(context, Librarian);
		}
        ...
        boolean isSecuredVPLMPrjAdmin = personObj.isAssigned(context, PropertyUtil.getSchemaProperty(context,"role_3DSRestrictedOwner"));
        boolean isSecuredVPLMPrjLeader = personObj.isAssigned(context, PropertyUtil.getSchemaProperty(context,"role_3DSRestrictedLeader"));
        return Boolean.valueOf( isLibrarian || isVPLMPrjAdmin || isVPLMPrjLeader || isSecuredVPLMPrjAdmin || isSecuredVPLMPrjLeader || userName.equals(PropertyUtil.getSchemaProperty(context, "person_UserAgent")) );
    }
