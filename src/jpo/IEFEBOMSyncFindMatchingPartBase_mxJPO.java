...
//import matrix.db.BusinessObjectItr;			//mkcsc
//import matrix.db.BusinessObjectList;			//mkcsc
...
public class IEFEBOMSyncFindMatchingPartBase_mxJPO
{
    ...
    protected String PART_RELEASE_PHASE         = "Production";
 ...
 MCADMxUtil					mxUtil					= null;
    ...
    public BusinessObject findMatchingPart(Context context, String[] args) throws Exception
    {
		...
		PART_RELEASE_PHASE       = ebomConfObject.getConfigAttributeValue(IEFEBOMConfigObject.ATTR_NEW_PART_RELEASE_PHASE);
...
//[NDM]
	...
	{		
		...
		DomainObject partObj = new DomainObject(partObject);
						...
						if(matchingRule.equals(MATCH_CADMODEL_REV))
						{
							...
							else
							{
								...
								if(PART_RELEASE_PHASE.equalsIgnoreCase("Development")){
									partRevSequence = MCADMxUtil.getRevisionSequenceForDevelopmentPhase(context);
								}
								else
								{
										...
										String instanceName, String cadType, String partType) throws Exception
	{
		...
		if(userName.equals("User Agent"))
		userName = cadObject.getOwner(context).getName();	//IR-761518: Deprecated method was used
	...
	protected Hashtable setSystemAttributeValues(Context context, DomainObject partObj, Hashtable attrMap) throws Exception
	{
