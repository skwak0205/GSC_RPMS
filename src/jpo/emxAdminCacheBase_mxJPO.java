...
public class emxAdminCacheBase_mxJPO
{
	...
	public static final String regExSeperator = "~\\|~";
        ...
        if (hAdminMap != null)
        {
             ...
             if (hAdminInfo != null)
             {
                 ...
                 if (version == null)
                 {
                     ...
                     String sCmd = "print " + sAdminType + " \"" + name + "\" select property[version].value property[application].value dump "+ seperator;
                     String sPropInfo = emxInstallUtil_mxJPO.executeMQLCommand(context, sCmd);
                     String[] stPropInfo = sPropInfo.split(regExSeperator);
                     if (stPropInfo.length == 2)
                     {
                         version = stPropInfo[0];
                         if (version == null || version.length() == 0)
                         {
                             throw (new Exception("Error: version information missing on " + sSymbolicName));
                         }
                         hAdminInfo.put(KEY_VERSION, version);
                         String application = stPropInfo[1];
        ...
        if (hAdminMap != null)
        {
             ...
             if (hAdminInfo != null)
             {
                 ...
                 if (application == null)
                 {
                     ...
                     if (stPropInfo.length == 2)
                     {
                         String version = stPropInfo[0];
                         if (version == null || version.length() == 0)
                         {
                             throw (new Exception("Error: version information missing on " + sSymbolicName));
                         }
                         hAdminInfo.put(KEY_VERSION, version);
                         application = stPropInfo[1];
                         hAdminInfo.put(KEY_APPLICATION, application);
                     }
                     else
                     {
        ...
        if (hAdminMap != null)
        {
             ...
             if (hAdminInfo != null)
             {
                 ...
                 if (aUnresolvedReferences == null)
                 {
                     ...
                     String sCmd = "print " + sAdminType + " \"" + name + "\" select property.name dump "+ seperator;
                     String sPropInfo = emxInstallUtil_mxJPO.executeMQLCommand(context, sCmd);
                     String[] stPropInfo = sPropInfo.split(regExSeperator);
                     for(int i=0;i<stPropInfo.length;i++)
                     {
                         String sPropName = stPropInfo[i];
        ...
        if (hPolicyMap != null)
        {
             ...
             if (hPolicyInfo != null)
             {
                 ...
                 if (hStates.isEmpty())
                 {
                     ...
                     String sCmd = "print policy" + " \"" + sPolicyName + "\" select property.name dump "+ seperator;
                     String sProperty = emxInstallUtil_mxJPO.executeMQLCommand(context, sCmd);
                     String[] stProperty = sProperty.split(regExSeperator);
                     sCmd = "print policy" + " \"" + sPolicyName + "\" select property.value dump "+ seperator;
                     String sValues = emxInstallUtil_mxJPO.executeMQLCommand(context, sCmd);
                     String[] stValue = sValues.split(regExSeperator);
                     sCmd = "print policy" + " \"" + sPolicyName + "\" select state dump "+ seperator;
                     String sStateNames = emxInstallUtil_mxJPO.executeMQLCommand(context, sCmd);
                     String[] stStateNames = sStateNames.split(regExSeperator);
                     ArrayList aStates = new ArrayList();
                     for(int i=0;i<stStateNames.length;i++)
                     {
                         aStates.add(stStateNames[i]);
                     }
                     for(int i=0;i<stProperty.length;i++)
                     {
                         String sProp = stProperty[i];
                         String sValue = stValue[i];
        ...
        throws Exception
    {
        ...
        if (hPolicyMap != null)
        {
             ...
             if (hPolicyInfo != null)
             {
                 ...
                 String sCmd = "print policy" + " \"" + name + "\" select property.name dump " + seperator;
                 String sStatePropNames = emxInstallUtil_mxJPO.executeMQLCommand(context, sCmd);
                 String[] arrStatePropNames = sStatePropNames.split(regExSeperator);
                 
                 // get all the property values
                 sCmd = "print policy" + " \"" + name + "\" select property.value dump " + seperator;
                 String sStatePropValues = emxInstallUtil_mxJPO.executeMQLCommand(context, sCmd);
                 String[] arrStatePropValues = sStatePropValues.split(regExSeperator);
                 ...
                 {
                     // get all the states
                     sCmd = "print policy" + " \"" + name + "\" select state dump " + seperator;
                     String sStateNames = emxInstallUtil_mxJPO.executeMQLCommand(context, sCmd);
                     String[] stStateNames = sStateNames.split(regExSeperator);
                     ArrayList aStates = new ArrayList();
                     for(int i=0;i<stStateNames.length;i++)
                     ...
                     for (int i=0; i < arrStatePropNames.length; i++)
                     {
                         String sStatePropName = arrStatePropNames[i];
                         String sStatePropValue = arrStatePropValues[i];
                         if (sStatePropName.startsWith("state_"))
                         {
                        	 if (!aStates.contains(sStatePropValue))
                             {
    ...
    public static void reloadAdminCache(Context context, String args[])  throws Exception
    {
    	if (adminCache != null)
        {
    		adminCache= null;
