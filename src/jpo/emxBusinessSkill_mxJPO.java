...
public class emxBusinessSkill_mxJPO extends emxBusinessSkillBase_mxJPO
{
          ...
          throws Exception
      {
          if (true)
          {
              throw new Exception(EnoviaResourceBundle.getProperty(context, "emxPersonOrgModelStringResource", context.getLocale(), "emxComponents.BusinessSkill.SpecifyMethodOnBusinessSkillInvocation"));
          }
          return 0;
      }
