...
public class emxTeamStateNameSortBase_mxJPO extends emxCommonBaseComparator_mxJPO
{
    ...
    /**
     * emxTeamStateNameSortBase JPO Constructor
     * @param context
     * @param args
     * @throws Exception
     */
    public emxTeamStateNameSortBase_mxJPO(Context context, String[] args)
        throws Exception
    {
    ...
    public emxTeamStateNameSortBase_mxJPO ()
    {
        try {
    ...
    public int compare (Object object1,Object object2) 
    {
        ...
        String stateDisplayName_1 = EnoviaResourceBundle.getProperty(context, FRAMEWORK, context.getLocale(), "emxFramework.State.Workspace."+stringValue1.replace(" ","_"));
        String stateDisplayName_2 = EnoviaResourceBundle.getProperty(context, FRAMEWORK, context.getLocale(), "emxFramework.State.Workspace."+stringValue2.replace(" ","_"));
        int diff = 0; 
