...
emxSecurityMigrationMigratePersonObjectsBase_mxJPO {
  ...
  public emxSecurityMigrationMigrateProgramPersonObjectsBase_mxJPO(Context context,
    ...
    public void migrateObjects(Context context, StringList objectList) throws Exception
    {
      ...
      StringList multiValueSelectables = new StringList(7);
      multiValueSelectables.add(MemberName);
      multiValueSelectables.add(MemberId);
      multiValueSelectables.add(MemberType);
      multiValueSelectables.add(MemberRevision);
      multiValueSelectables.add(MemberProjectRole);
      multiValueSelectables.add(SecurityContextName);
      multiValueSelectables.add(memberRelId);
