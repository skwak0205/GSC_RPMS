...
public class emxCommonDocumentOwnershipMigrationBase_mxJPO extends emxCommonMigration_mxJPO
{
    ...
    {     
     ...
     System.out.println("*******************objectSelects : "+ objectSelects.toString());
        ...
        while( itr.hasNext())
        {
            try{
                ...
                System.out.println(" valueMap : "+valueMap.toString());
               ...
               // mqlLogRequiredInformationWriter("Checking  Ownership for Objects Connected with Reference Document relationship............");
                StringList parentIds = FrameworkUtil.split(strParentId, "\7");
				StringList parentTypes = FrameworkUtil.split(strParentType, "\7");
				for (int i = 0; i < parentIds.size(); i++) {
					updateDocumentOwnership(context, strObjId, (String)parentIds.get(i),  (String)parentTypes.get(i));
				}
                ...
                updateDocumentOwnership(context, strObjId, strParentId,  strParentType);                
               ...
               mqlLogRequiredInformationWriter("Checking  Ownership for Objects Connected with Issue relationship............");           
                updateDocumentOwnership(context, strParentId , strObjId,  strParentType);
    ...
    protected void updateDocumentOwnership(Context context, String ObjectID, String strParentId, String  strParentType) throws Exception{              
        
     String comment ="Ownership Inheritance from " + strParentType;
