...
public class emxPortfolioBase_mxJPO extends emxDomainObject_mxJPO {
    ...
    public MapList getAllPortFolios (Context context, String[] args) throws Exception {
       // forming the Owner Pattern clause - BAD QUERY FIX
        String strDisplayOwnedPortfolios = "true";
        try {
        	strDisplayOwnedPortfolios = EnoviaResourceBundle.getProperty(context, "eServiceSuiteProductLine.PortfolioToDisplay.DisplayOnlyOwnedPortfolios");
        } catch (Exception e) {}
        String strOwnerCondition = null;	
		if(strDisplayOwnedPortfolios.equalsIgnoreCase("true")){
			strOwnerCondition = context.getUser();	
	    }
    ...
    protected MapList getPortFolios (Context context, String strWhereCondition, String strOwnerCondition) throws Exception {
        ...
        MapList mapIds = findObjects(context, strType, null,DomainConstants.EMPTY_STRING,strOwnerCondition,null,strWhereCondition,true, objectSelects);
        return  mapIds;
    }
     /**
    ...
    public List getPortfolioProductIds(
        ...
        StringList lstObjSelects = new StringList(DomainObject.SELECT_ID);
