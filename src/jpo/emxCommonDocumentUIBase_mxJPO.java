                                  ...
                                  throws Exception
    {
        ...
        try
        {
            ...
            while( itr.hasNext() )
            {
                ...
                if ( routeId != null)
                {
                    showRoute.add("<img border='0' src='../common/images/iconSmallRoute.png'/>");
                } else {
                    showRoute.add("&#160;");
                }
            }
    ...
    */
        ...
        throws Exception
    {
           ...
           if(objectList == null || objectList.size() <= 0)
           {
            ...
            if (CommonDocument.TYPE_DOCUMENTS.equals(parentType))
            {
            	if(CommonDocument.canView(context, contentObjectMap,strFileFormat )){
					...
					if(!isprinterFriendly) {
						if (moveFilesToVersion){
							...
							if (viewerURLMap != null){
								//XSSOK
								newURL = emxCommonFileUI_mxJPO.getViewerURL(context,                            				  activeFileVersionID,
				   ...
				   {
					   newURL = "<img src=\"../common/images/iconActionView.gif\" border=\"0\" alt=\""+sTipView+"\" title=\""+sTipView+"\"></img>";
				   }
                 }
				//Can Download
				if(CommonDocument.canDownload(context, contentObjectMap)){
                   ...
                   {
                   	newURL+="<img style=\"border:0; padding: 2px;\" src=\"../common/images/iconActionDownload.gif\" alt=\""+sTipDownload+ "\" ></img>";
                ...
                if (!isprinterFriendly)
                {
                   	...
                   	newURL+="<a href=\"javascript:getTopWindow().showSlideInDialog('" +strBuf.toString()+ "')\"><img style=\"border:0; padding: 2px;\" src=\"../common/images/iconSmallSubscription.gif\" alt=\""+sTipSubscription+"\" title=\""+sTipSubscription+"\"></img></a>";
					} else {
                   	newURL+="<img style=\"border:0; padding: 2px;\" src=\"../common/images/iconSmallSubscription.gif\" alt=\""+sTipSubscription+ "\" ></img>";
	                }
            ...
            {
                       	   newURL+="<img style=\"border:0; padding: 2px;\" src=\"../common/images/iconActionCheckOut.gif\" alt=\""+sTipCheckout+ "\" ></img>";
             ...
             if(CommonDocument.canCheckin(context, contentObjectMap) || VCDocument.canVCCheckin(context, contentObjectMap)){
   				 ...
   				 vcFile =(Boolean.valueOf((String) contentObjectMap.get("vcfile"))).booleanValue();
   					...
   					if (!vcDocument)
							...
							if(!isprinterFriendly)
							{
   							  newURL+="<a href=\"javascript:showModalDialog("+strBuf.toString()+");\"><img style=\"border:0; padding: 2px;\" src=\"../common/images/iconActionCheckIn.gif\" alt=\""+sTipCheckin+"\" title=\""+sTipCheckin+"\"></img></a>";
							}
							else
							{
   				  ...
   				  //can unlock document 
   						...
   						if (isContextDocumentOwner || isAnyFileLockedByContext) {
							...
							else
							{
   	                       ...
   	                       {
   								if (isAnyFileLockedByContext) {
   	                    	   newURL+="<img style=\"border:0; padding: 2px;\" src=\"../common/images/iconActionCheckIn.gif\" alt=\""+sTipCheckin+"\" title=\""+sTipCheckin+"\"></img>";
   								}
   	                    	   if (fileCount<=1)
   	                    	   {
   	       							if (isContextDocumentOwner || isAnyFileLockedByContext) {
   										newURL+="<img style=\"border:0; padding: 2px;\" src=\"../common/images/iconActionUnlock.gif\" alt=\""+docLocker+"\" title=\""+docLocker+"\"></img>";
   	                    		   }
   	                    	   }
                           }
                          }
                         ...
                         if(!isprinterFriendly)
        {
                           ...
                           newURL+="<a href=\"javascript:showModalDialog("+strBuf.toString()+");\"><img style=\"border:0; padding: 2px;\" src=\"../common/images/iconActionAppend.gif\" alt=\""+sTipAddFiles+"\" title=\""+sTipAddFiles+"\"></img></a>";

                          }
                          else
                          {
                       	   newURL+="<img style=\"border:0; padding: 2px;\" src=\"../common/images/iconActionAppend.gif\" alt=\""+sTipAddFiles+"\" title=\""+sTipAddFiles+"\"></img>";
