					...
					try
					{
						...
						if(value!=null && !value.equals(""))
						{
								  if (newMapKeyName.equalsIgnoreCase("type")){
												...
												//TSK7460132 : UINavigatorUtil.getI18nString method is deprecated method and does not support custom object NLS support. So EnoviaResourceBundle API used 
											//	selectPropValue = UINavigatorUtil.getI18nString(selectProp,"emxFrameworkStringResource",(String) detailsMap.get("language"));
												selectPropValue  = EnoviaResourceBundle.getFrameworkStringResourceProperty(context, selectProp, new Locale((String) detailsMap.get("language")));									
									}
