  ...
  public MapList getUsage(Context context, String[] args)throws Exception
  {
    MapList mapListResult = null;
      ...
      else
      {
        ...
        mulValSelects.add("from["+Download.RELATIONSHIP_DOCUMENT_USAGE+"].to.name");
        mulValSelects.add("from["+Download.RELATIONSHIP_DOCUMENT_USAGE+"].to.id");
        mulValSelects.add("from["+Download.RELATIONSHIP_DOCUMENT_USAGE+"]."+SELECT_ORIGINATED);
        mulValSelects.add("from["+Download.RELATIONSHIP_DOCUMENT_USAGE+"]."+SELECT_ID);
        ...
        slBusSelect.add("from["+strSelWhere+"]."+SELECT_ORIGINATED);
        slBusSelect.add("from["+strSelWhere+"]."+SELECT_ID);
        mapList = DomainObject.findObjects(context, Download.TYPE_DOWNLOAD, QUERY_WILDCARD, QUERY_WILDCARD, QUERY_WILDCARD, QUERY_WILDCARD, sbWhere.toString(), "", false, slBusSelect, sQueryLimit, mulValSelects);
  ...
  public MapList getDownloads(Context context, String[] args)throws Exception
  {
    ...
    short sQueryLimit = (short)0;
      ...
      }else
      {
        ...
        mulValSelects.add("from["+Download.RELATIONSHIP_DOWNLOAD_DOCUMENT+"]."+SELECT_ID);
        mulValSelects.add("from["+Download.RELATIONSHIP_DOWNLOAD_DOCUMENT+"].to.name");
        mulValSelects.add("from["+Download.RELATIONSHIP_DOWNLOAD_DOCUMENT+"].to.id");
        ...
        mapList = DomainObject.findObjects(context, Download.TYPE_DOWNLOAD, QUERY_WILDCARD, QUERY_WILDCARD, QUERY_WILDCARD, QUERY_WILDCARD, "", false, slBusSelect, mulValSelects);
      }
