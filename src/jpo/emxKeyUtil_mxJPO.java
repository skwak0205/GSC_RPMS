  ...
  /**
    ...
    */
    ...
    public static void setCompanyKey(Context context, String[] args) throws Exception
    {
        ...
        String[] oids = new String[1];
        oids[0] = companyId;
        String primaryKeySelect = "attribute["+PropertyUtil.getSchemaProperty(context, "attribute_PrimaryKey")+"]";
        ...
        String key = companyObject.getInfo(context,primaryKeySelect);
        String user = personObject.getInfo(context, "name");
        String compKeyAdminProperty = "Company Key";
		String personAdminType = "person";
        PropertyUtil.setAdminProperty(context, personAdminType, user, compKeyAdminProperty, key);
    }
