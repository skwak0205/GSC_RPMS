...
public class IEFActionAccess_mxJPO
{
	...
	public Boolean canShowAsSavedView(Context context , String []args) throws Exception 
	{
		...
		try
		{
			...
			String objectId		= (String) paramMap.get("objectId");
			MCADMxUtil mxUtil	 = new MCADMxUtil(context, new MCADServerResourceBundle(language), new IEFGlobalCache());
			isAsSavedViewEnabled = mxUtil.isAsSavedViewEnabled(context,null,objectId);	
		}
		catch(Exception e)
		{
	...
	public Boolean showForAppletFree(Context context , String []args) throws Exception 
	{
		return MCADMxUtil.IsAppletFreeUI(context);
		
	}
	
	public Boolean doNotShowForAppletFree(Context context , String []args) throws Exception 
	{
		return !MCADMxUtil.IsAppletFreeUI(context);
