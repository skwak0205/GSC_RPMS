...
public class emxLocationBase_mxJPO extends emxDomainObject_mxJPO
{
        ...
        throws Exception
    {
        if (true)
        {
            throw new Exception(EnoviaResourceBundle.getProperty(context, "emxPersonOrgModelStringResource", context.getLocale(), "emxComponents.Location.SpecifyMethodLocationInvocation"));
        }
        return 0;
    }
    ...
    */
    public int checkPlantIdUniqueness(Context context, String[] args) throws Exception
    {
        ...
        if(attr_PlantID.equals(attributeName)) {
            ...
            if(objectList.size() != 0) {
              String strMessage = EnoviaResourceBundle.getProperty(context,"emxPersonOrgModelStringResource",new Locale(context.getSession().getLanguage()),"emxComponents.Location.PlanIdExists");
    ...
    public void createLocationPostProcess(Context context, String[] args) throws Exception {
        ...
        if (strOrganizationId == null) {
          throw new MatrixException(EnoviaResourceBundle.getProperty(context, "emxPersonOrgModelStringResource", new Locale(languageStr), "emxComponents.Common.InvalidRequestParameters"));
        }
        ...
        try {            
            ...
            if("create".equals(mode)) {
                if(orgId != null) {
                    ...
                    sOrgTitle = (String)objMap.get(DomainConstants.SELECT_ATTRIBUTE_TITLE);
                }
               ...
               */
                if(DomainConstants.TYPE_BUSINESS_UNIT.equals(parentType)) {
                    buffer.append("<img src=\"../common/images/iconBusinessUnit16.png\" name=\"imgBusinessUnit\" id=\"imgBusinessUnit\" alt=\"*\" />").append(XSSUtil.encodeForXML(context, sOrgTitle));                                    
                }
                else {
                    buffer.append("<img src=\"../common/images/iconCompany16.png\" name=\"imgCompany\" id=\"imgCompany\" alt=\"*\" />").append(XSSUtil.encodeForXML(context, sOrgTitle));
                }
            }
            else {
                String sParentType = "";
                ...
                if(locId != null) {
                    ...
                    busRelSelects.addElement("to["+DomainConstants.RELATIONSHIP_ORGANIZATION_LOCATION+"].from.attribute[Title]");
                    Map map = location.getInfo(context,busRelSelects);
                    ...
                    sParentTitle = (String)map.get("to["+DomainConstants.RELATIONSHIP_ORGANIZATION_LOCATION+"].from.attribute[Title]");
                }
                ...
                if("edit".equals(mode)) {
                    if(DomainConstants.TYPE_BUSINESS_UNIT.equals(sParentType)) {
                        buffer.append("<img src=\"../common/images/iconBusinessUnit16.png\" name=\"imgBusinessUnit\" id=\"imgBusinessUnit\" alt=\"*\" />").append(sParentTitle);              
                    }
                    else {                    
                        buffer.append("<img src=\"../common/images/iconCompany16.png\" name=\"imgCompany\" id=\"imgCompany\" alt=\"*\" />").append(sParentTitle);
                    }
                }
                else {
                    if(DomainConstants.TYPE_BUSINESS_UNIT.equals(sParentType)) {
                    	if(isExport){
                    		...
                    		buffer.append("<img src=\"../common/images/iconBusinessUnit16.png\" name=\"imgBusinessUnit\" id=\"imgBusinessUnit\" alt=\"*\" />");
                    		if(isPrinterFriendly){
                    		buffer.append(XSSUtil.encodeForHTML(context,sParentTitle));
                    	}else{
                    		buffer.append("<a href=\"").append(popTreeUrl).append("\">").append(sParentTitle).append("</a>");                		
                    	}
                      }                        
                    }
                    else {
                    	if(isExport){
                    		...
                    		buffer.append("<img src=\"../common/images/iconCompany16.png\" name=\"imgCompany\" id=\"imgCompany\" alt=\"*\" />");
                    		if(isPrinterFriendly){
                    		buffer.append(XSSUtil.encodeForHTML(context,sParentTitle));
                    	}else{
                    		buffer.append("<a href=\"").append(popTreeUrl).append("\">").append(sParentTitle).append("</a>");                    
    ...
    public Map createLocationObject(Context context, String args[]) throws FrameworkException {
        try {
            ...
            // Need the BusinessUnit id in order to add a location.
            if (strOrganizationId == null) {
              throw new FrameworkException(EnoviaResourceBundle.getProperty(context, "emxPersonOrgModelStringResource", context.getLocale(), "emxComponents.Common.InvalidRequestParameters"));
            }
