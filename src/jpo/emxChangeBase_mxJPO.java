...
public MapList getAssignees(Context context, String[] args)
   ...
   public List checkAssignedAffectedItemRelExists(Context context, String objectId, String[] arrRelIds, String[] strObjectId) throws Exception
   	{
		...
		List strConsolidatedList = new ArrayList(arrRelationIds.length);
 ...
 */
 public StringList removeAssignee(Context context, String[] args)
        throws FrameworkException
    {
			...
			List strCombinedList = new StringList();
     ...
     public Vector getCompleteName (Context context, String[] args) throws Exception {
         ...
         for (int i = 0; i < iNoOfObjects; i++) {
             ...
             else
             {
                 ...
                 strFullName = "<img src = \"images/iconPerson16.png\"/>&#160;<a href=\"JavaScript:emxTableColumnLinkClick('emxTree.jsp?name="+XSSUtil.encodeForURL(context, strLastName+strFirstName)+"&amp;treeMenu=type_Person&amp;emxSuiteDirectory="//Modified By Infosys for Bug # 304580 Date 05/18/2005
