        ...
        if(programExists)
        {
			...
			ResourceBundle frameworkBundle = null;
                ...
                if(tempObjectMapList != null && !(tempObjectMapList.isEmpty()))
                {
					...
					// special handling to get Collections #IR-475535.. 
					...
					else
{
   ...
   public String getBusId(Context context, String[] args) throws Exception
   {
    ...
    public  String getDisplayValue(Context context, String[] args) throws Exception
    {
        ...
        return getDisplayValue(context,adminType, adminName, languageStr);		//IR-817670 : added context as argument
    }

    public  String getDisplayValue(Context context,String admin, String adminName, String languageStr)
    {
        String tempDisplayName = adminName;
        try
        {
        	//IR-817670 : i18nNow is deprecated API. so used new API EnoviaResourceBundle
          //  tempDisplayName = i18nNow.getAdminI18NString(admin, adminName, languageStr);
        	tempDisplayName = getMXI18NString(context,adminName,"", languageStr,admin);	//getMXI18NString(Context context,String preString,String postString, String languageStr,String prefix)
        }catch(Exception me)
        {
    ...
    public  String getSelectedValues(Context context, AttributeType attrTypeObj, String languageStr)
    {
        ...
        try
        {
            ...
            while(stringListItr.next())
            {
                ...
                tempBuffer.append(";");
                tempBuffer.append(getMXI18NString(context,sChoiceVal,attrTypeObj.getName(), languageStr,"Range"));	//IR-822367 : added context as argument
                tempBuffer.append("|");
            }
    ...
    //
    public  String getMXI18NString(Context context,String preString,String postString, String languageStr,String prefix) throws MatrixException
    {
    	//IR-822367 : For attribute value NLS, remove interface/ attribute group name from attribute name
        com.matrixone.apps.domain.util.i18nNow loc = new com.matrixone.apps.domain.util.i18nNow();
        
        if(prefix.equals("Range")){
        if(postString != null && postString.startsWith("XP_") && postString.contains(".")) {
			String[] strArray = postString.split("\\.");
			postString=  strArray[strArray.length - 1];
        }
        }
        ...
        try{
        	//IR-817670 and IR-822367: i18nNow is deprecated API. so used new API EnoviaResourceBundle
        //  String I18NreturnString = (String) loc.GetString("emxFrameworkStringResource ", languageStr, text);
        	String I18NreturnString = EnoviaResourceBundle.getFrameworkStringResourceProperty(context, text, new Locale(languageStr));
        	if ((!"".equals(I18NreturnString)) && (I18NreturnString != null) && !(I18NreturnString.equals(text))){
