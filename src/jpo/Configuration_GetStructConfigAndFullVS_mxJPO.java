 ...
 * ${CLASSNAME}
 */
public final class Configuration_GetStructConfigAndFullVS_mxJPO extends CompletionJPOEvaluator {
	...
	private final static com.dassault_systemes.EKLEngine.common.lib.implementation.StringType _STRING_8__PLMConfigVariabilityS = new com.dassault_systemes.EKLEngine.common.lib.implementation.StringType("PLMConfigVariabilitySpace");
	private final static com.dassault_systemes.EKLEngine.common.lib.implementation.StringType _STRING_9__PLMConfigVariabilityS = new com.dassault_systemes.EKLEngine.common.lib.implementation.StringType("PLMConfigVariabilitySpace_AddVariabilitySpaceFullContent");
	private final static com.dassault_systemes.EKLEngine.common.lib.implementation.StringType _STRING_10__PLMCORE_div_PLMCoreI = new com.dassault_systemes.EKLEngine.common.lib.implementation.StringType("PLMCORE/PLMCoreInstance");
	private final static com.dassault_systemes.EKLEngine.common.lib.implementation.StringType _STRING_11__PLMConfigEffectivity = new com.dassault_systemes.EKLEngine.common.lib.implementation.StringType("PLMConfigEffectivity");
	private final static com.dassault_systemes.EKLEngine.common.lib.implementation.StringType _STRING_12__PLMConfigEffectivity = new com.dassault_systemes.EKLEngine.common.lib.implementation.StringType("PLMConfigEffectivity_AddInstanceEffectivity");
	private final static com.dassault_systemes.EKLEngine.common.lib.implementation.StringType _STRING_13__PLMConfigEffectivity = new com.dassault_systemes.EKLEngine.common.lib.implementation.StringType("PLMConfigEffectivity/PLMCfgEffectivity");
	private final static com.dassault_systemes.EKLEngine.common.lib.implementation.StringType _STRING_14__PLMBRIDGE_CfgStaticM = new com.dassault_systemes.EKLEngine.common.lib.implementation.StringType("PLMBRIDGE_CfgStaticMapping");
	private final static com.dassault_systemes.EKLEngine.common.lib.implementation.StringType _STRING_15__PLMBRIDGE_CfgStaticM = new com.dassault_systemes.EKLEngine.common.lib.implementation.StringType("PLMBRIDGE_CfgStaticMapping_AddInstanceStaticMapping");
	private final static com.dassault_systemes.EKLEngine.common.lib.implementation.StringType _STRING_16__PLMBRIDGE_CfgStaticM = new com.dassault_systemes.EKLEngine.common.lib.implementation.StringType("PLMBRIDGE_CfgStaticMapping/PLMCfgStaticMapping");
	private final static com.dassault_systemes.EKLEngine.common.lib.implementation.StringType _STRING_17__PLMBRIDGE_CfgStaticM = new com.dassault_systemes.EKLEngine.common.lib.implementation.StringType("PLMBRIDGE_CfgStaticMapping_AddStaticMappingQuery");
	...
	public final void evaluate(matrix.db.Context iContext, com.dassault_systemes.EKLEngine.common.lib.PLMIDSet iPLMIDSet, com.dassault_systemes.EKLEngine.common.lib.PLMIDSet oPLMIDSet)	
		...
		PLMRouteSetVSContent.setValue( com.dassault_systemes.EKLEngine.completion.lib.Completion.ExecutePLMFunction( iContext , _STRING_8__PLMConfigVariabilityS, _STRING_9__PLMConfigVariabilityS, new com.dassault_systemes.EKLEngine.common.lib.implementation.ObjectType[] { PLMIDSetVS } ) );
		PLMIDSetVSContent.setValue( com.dassault_systemes.EKLEngine.common.lib.PLMRouteSet.Ids( PLMRouteSetVSContent ) );
		PLMIDSetInputInst.setValue( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.Restrict( iContext , iPLMIDSet, _STRING_10__PLMCORE_div_PLMCoreI ) );
		PLMRouteSetInstEff.setValue( com.dassault_systemes.EKLEngine.completion.lib.Completion.ExecutePLMFunction( iContext , _STRING_11__PLMConfigEffectivity, _STRING_12__PLMConfigEffectivity, new com.dassault_systemes.EKLEngine.common.lib.implementation.ObjectType[] { PLMIDSetInputInst } ) );
		PLMIDSetInstEff.setValue( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.Restrict( iContext , com.dassault_systemes.EKLEngine.common.lib.PLMRouteSet.Ids( PLMRouteSetInstEff ), _STRING_13__PLMConfigEffectivity ) );
		PLMRouteSetInstStcMpg.setValue( com.dassault_systemes.EKLEngine.completion.lib.Completion.ExecutePLMFunction( iContext , _STRING_14__PLMBRIDGE_CfgStaticM, _STRING_15__PLMBRIDGE_CfgStaticM, new com.dassault_systemes.EKLEngine.common.lib.implementation.ObjectType[] { PLMIDSetInputInst } ) );
		PLMIDSetInstStcMpg.setValue( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.Restrict( iContext , com.dassault_systemes.EKLEngine.common.lib.PLMRouteSet.Ids( PLMRouteSetInstStcMpg ), _STRING_16__PLMBRIDGE_CfgStaticM ) );
		PLMRouteSetStcMpgQuery.setValue( com.dassault_systemes.EKLEngine.completion.lib.Completion.ExecutePLMFunction( iContext , _STRING_14__PLMBRIDGE_CfgStaticM, _STRING_17__PLMBRIDGE_CfgStaticM, new com.dassault_systemes.EKLEngine.common.lib.implementation.ObjectType[] { PLMIDSetInstStcMpg } ) );
		...
		oPLMIDSet.setValue( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.plus( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.plus( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.plus( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.plus( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.plus( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.plus( iPLMIDSet, PLMIDSetContext ), PLMIDSetQueries ), PLMIDSetVSContent ), PLMIDSetInstEff ), PLMIDSetInstStcMpg ), PLMIDSetStcMpgQuery ) );
	}
}
