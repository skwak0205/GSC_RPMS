...
public class IEFStartDesignJPO_mxJPO
{
	...
	public String createDesignObject(Context context, String[] args) throws MCADException
	{
		...
		try
		{
			...
			attributeList.addElement(new Attribute(new AttributeType(newlyCreatedinMatrix), "true"));
			...
			if(isAutoNameSelected.equalsIgnoreCase("true"))
			{
				...
				String symbolicBaseTypeName = util.getSymbolicName(context, "type", baseType);
                                Vector vctAutonames = util.getAutoNamesForCADTypes(context, autonameSeries, symbolicBaseTypeName, 1);
				...
				majorObject.create(context, designObjPolicy, null, attributeList); //majorObject.create(context, designObjPolicy);
			...
			{			    
				...
				if(!doesObjectExist(context, designObjType, designObjName))
				{
					...
					majorObject.create(context, designObjPolicy, null, attributeList);
			...
			modAttrList.addElement(new Attribute(new AttributeType(newlyCreatedinMatrix), "true"));
