    ...
    if (sWorkspaceFolder.equals("*"))
    {
      ...
      while(vaultNamesItr.hasNext())
      {
        ...
        try
        {
            ...
            MapList docMapList = FrameworkUtil.toMapList(query.getIterator(context, selects,limit), FrameworkUtil.NEW_MULTI_VALUE_LIST);
...
//Added for Bug 312500 - End
  ...
  templateMapList = DomainObject.getInfo(context, (String [])docIdList.toArray(new String []{}), selects, mulValSelects);
