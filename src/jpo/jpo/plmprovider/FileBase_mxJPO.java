   ...
   static private String getFileExtension(String strFileName) {
    ...
    private String getMarkupID(Context context, String objectID) throws Exception
    {
        ...
        */
        ...
        Hashtable map = null;
        try{
			   String whereClause = "(attribute["+DomainConstants.ATTRIBUTE_CHECKIN_REASON+"] == 'LMO::Default_InWork_Data')";
			   mapList = parentObject.getRelatedObjects(context, 
													...
													whereClause, 
													null);
			   map = (Hashtable)mapList.get(0);
        
        }catch (Exception e)
		{
			log("getMarkUPId exception " + e);
		}
        if (map != null)
        {
