...
/*
 ...
 @quickreview KIE1 ZUD 06/10/2016	IR-447622-3DEXPERIENCER2018x: R2017X: Selected Requirement specifications gets added multiple times to specifications of a Regulation.  
 @quickreview HAT1 ZUD 10/01/2018	IR-570359-3DEXPERIENCER2018x: R20-STP: On Specification List view, Name of the Project in project column is not shown for the specification under folder.   
*/
public class emxRequirementGroupBase_mxJPO extends DomainObject
{
	...
	*/
	...
	throws Exception
	{
		...
		MapList mapBusId = findObjects(context,strType,
			 null,null,strOwner,null,"",true,objectSelect);
		return mapBusId;
	}
	...
	*/
	...
	throws Exception
	{
		System.out.println("emxRequirementGroupBase_mxJPO.java: expandGroup");
		...
		StringList objSelect = new StringList(SELECT_ID);
			...
			objSelect.addElement(ReqConstants.SELECT_READ_ACCESS);  // HAT1 ZUD: IR-570359-3DEXPERIENCER2018x fix.
		...
		// ++ AGM1 ZUDIR-798668-3DEXPERIENCER2021x
		expanded.sortStructure(context, "relationship,attribute[TreeOrder]", ",", "string,real", ",");
		// -- AGM1 ZUDIR-798668-3DEXPERIENCER2021x
	...
	throws Exception
	{
		...
		if(obj.isKindOf(context, ReqSchemaUtil.getRequirementGroupType(context)))
		{
		...
		}else if(obj.isKindOf(context, ReqSchemaUtil.getRequirementType(context)))
		{
