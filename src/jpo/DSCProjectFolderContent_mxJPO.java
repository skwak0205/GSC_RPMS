...
public class DSCProjectFolderContent_mxJPO extends DomainObject
{
	...
	public MapList getFolderContent(Context context, String[] args) throws Exception
	{
		...
		try
		{
			...
			//IR-592057-3DEXPERIENCER2018x

			boolean bIsTypeWorkspaceVault = (sTypeName.equals(DomainConstants.TYPE_WORKSPACE_VAULT) || sTypeName.equals(DomainConstants.TYPE_CONTROLLED_FOLDER));
