        ...
        Exception
    {
        ...
        if(objectId != null && !"".equals(objectId) && !"null".equals(objectId))
        {
            ...
            try{
				...
				kindOfGenLibOrClass = domainObj.isKindOf(context, LibraryCentralConstants.TYPE_GENERAL_CLASS) || domainObj.isKindOf(context, LibraryCentralConstants.TYPE_GENERAL_LIBRARY);
			}catch(Exception e)
			{
				e.printStackTrace();
				throw e;
    ...
    public int modifyInterfaceOnAddChildren(Context context, String[] args) throws Exception
    {
        ...
        if(args.length > 0)
        {
            ...
            try{
                ...
                //currentParentsList.addElement(strParentInterface);//bae3 - to avoid deriving from same parent twice,
                if( !currentParentsList.contains(strParentInterface) )//bae3 - so that duplicate parent/child interfaces can be restricted
