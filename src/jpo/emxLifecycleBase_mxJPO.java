            ...
            else
            {
                ...
                if(toList.size() >= 1 && ccList.size() >= 1) {
					...
					if(!isGroupRoleIncluded) {
			            ...
			            RouteTaskNotification notifyObj = RouteTaskNotification.getInstance(context, sRouteContentTypesNotif.toString());
...
//          For Bug 347000
            ...
            if (mlRoutes.size() == 0 || "True".equalsIgnoreCase(sRouteChooseUserGroup)) {
                ...
                try {
					...
					if("true".equalsIgnoreCase(hasPromoteAccess) && Route.isStateBlockingAllowed(context, strTypeName)){						  
