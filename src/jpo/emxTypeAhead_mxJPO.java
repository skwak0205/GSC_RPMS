...
{ 
	...
	protected HashMap getParamMap(Context context) throws Exception
	{
		if(_paramMap == null)
		{
            ...
            String fieldQueryValue     = UIUtil.getValue(paramMap, "fieldQueryProgram");
            if(UIUtil.isNotNullAndNotEmpty(fieldQueryValue)) {
                   fieldQueryValue        = getQueryField(context, fieldQueryValue);
                   field = fieldQueryValue.length() > 0 ? (field + ":" + fieldQueryValue) : field;
            } 
