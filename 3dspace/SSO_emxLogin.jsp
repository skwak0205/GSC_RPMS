...
//System.out.println("####################################  HD_EMXLOGIN.jsp ####################################");

String redirectParam = request.getParameter("redirectParam");
System.out.println("#########HD LOGIN  22####"+redirectParam);
String mode = request.getParameter("mode");
System.out.println("#########HD LOGIN  mode####"+mode);
...
if (Framework.isLoggedIn(request))
{
    ...
    //System.out.println("FRAMEWORK LOGGED IN");
    ...
    if (SecurityContext != null && !"".equals(SecurityContext) ) {
     ...
     //JPA-
    targetPage = "oslc/SSO_emxSecurityContextSelection.jsp?rToken=" + XSSUtil.encodeForURL(request.getParameter("rToken")) + "&port=" + XSSUtil.encodeForURL(request.getParameter("port")) + "&ticket=" + XSSUtil.encodeForURL(request.getParameter("ticket"))+ "&redirectParam=" + XSSUtil.encodeForURL(request.getParameter("redirectParam"))+ "&mode=" + XSSUtil.encodeForURL(request.getParameter("mode"));
...
%>
    ...
    if ((FrameworkTarget != null) && (!"".equals(FrameworkTarget)))
    {
        ...
        {
            System.out.println("1 Target: " + forwardURL);
            ...
            FrameworkTarget = "/" + FrameworkTarget.split("/")[1] + "/" + FrameworkTarget.split("/")[2] + "/SSO_" + FrameworkTarget.split("/")[3] + "?rToken=" + XSSUtil.encodeForURL(request.getParameter("rToken"))+ "&port=" + XSSUtil.encodeForURL(request.getParameter("port")) + "&ticket=" + XSSUtil.encodeForURL(request.getParameter("ticket"));
            System.out.println("2 Target: " + FrameworkTarget);
      ...
      if (forwardURL != null )
      {
          System.out.println("3 Target: " + forwardURL);
          Framework.setTargetPage(session, forwardURL);
      }
    }
