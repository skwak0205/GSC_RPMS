<%--  emxTableAutoFilterFooter.jsp
   ...
   static const char RCSID[] = $Id: emxTableAutoFilterFooter.jsp.rca 1.7 Wed Oct 22 15:48:29 2008 przemek Experimental przemek $
--%>
...
<table width="100%" border="0" align="center" cellspacing="2" cellpadding="3">
    ...
    <td align="right">
        ...
        <tr>
            <td><a href="javascript:filterTable()"><img src="images/buttonDialogDone.gif" border="0" alt="<emxUtil:i18nScript localize="i18nId">emxFramework.Common.Done</emxUtil:i18nScript>" /></a></td>
            <td><a href="javascript:filterTable()" class="button"><emxUtil:i18nScript localize="i18nId">emxFramework.Common.Done</emxUtil:i18nScript></a></td>
            <td>&nbsp;&nbsp;</td>
