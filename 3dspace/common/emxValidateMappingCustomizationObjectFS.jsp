...
<%
  ...
  contentURLBuffer.append("emxValidateMappingCustomizationObject.jsp");
  ...
  String PageHeading = "emxVPLMSynchro.CustomSync.SyncMappingValidation";
  ...
  fs.createFooterLink("emxVPLMSynchro.CustomSync.Cancel",
                      "parent.window.close()",
                      roleList,
                      false,
                      true,
