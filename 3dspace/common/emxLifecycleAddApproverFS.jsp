...
<%
  ...
  String contentURL = "emxLifecycleAddApprover.jsp";
  ...
  String PageHeading = "emxFramework.Heading.AddApprover";
  ...
  String strPageSubHeading = UINavigatorUtil.getI18nString(
	...
	String strName = XSSUtil.encodeForURL(context,(String) mapObjectInfo
  ...
  fs.createFooterLink("emxFramework.Lifecycle.Apply",
                      "apply_onclick()",
                      "role_GlobalUser",
                      false,
                      true,
