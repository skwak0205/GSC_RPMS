...
<%
    ...
    VPLMBusObject boToSync  = new VPLMBusObject(context,objectId);
	    ...
	    boolean isPartConfigured = MDCollabSynchronizerObject.isPartConfigured(context, boToSync);
...
<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        {
			if(document.emxSyncDialog.DETAILED_REPORT.checked)
				return "true";
			else
			 return "false";
        }
...
<TABLE BORDER="0" CELLPADDING="5" CELLSPACING="2" WIDTH="100%">
	...
	<TR>
		...
		<TD CLASS="inputField"><INPUT TYPE="CHECKBOX"
					NAME="DETAILED_REPORT" <%=checkedTransfer%> ></TD>
	</TR>
	<%
