<%-- emxChartOptionsHeader.jsp
   ...
   static const char RCSID[] = $Id: emxChartOptionsHeader.jsp.rca 1.5 Wed Oct 22 15:48:00 2008 przemek Experimental przemek $
--%>
<html>
...
try
{
    ...
    String header           = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", new Locale(strLanguage), "emxFramework.ChartOptions.OptionsHeader");
%>
...
<%
    ...
    if(ex.toString()!=null && (ex.toString().trim()).length()>0)
        emxNavErrorObject.addMessage("emxChartOptionsHeader.jsp:" + ex.toString().trim());
}
%>
