...
%>
<div id="ExtpageHeadDiv" class="page-head" style="height:0px;width:0px;"></div>
<div id="panelToggle" class="panel-toggle open" style="height:0px;width:0px;"></div>
<div id="leftPanelMenu" class="slide-in-panel menu categories" style="display:none;height:0px;width:0px;">
  <div id="togglecat" class="toggle" style="height:0px;width:0px;">
  ...
  <div id="catMenu" class="menu categories" style="display:none;top:0px;height:0px;width:0px;"></div>
  <div id="leftPanelTree" style="display:none;top:16px;height:0px;width:0px;"></div>
</div>
<div id="mx_divGrabber" style="bottom: 0px; z-index: 1; top: 159px; left: 212px;height:0px;width:0px;">
  <div id="mx_divGrabberHead"></div>
  <div id="mx_divGrabberBody" style="top: 126px;height:0px;width:0px;"></div>
...
<script>
  ...
  function setDisplay(){
    ...
    $('#ExtpageHeadDiv').css('top','0px');
    $('#ExtpageHeadDiv').css('height','0px');
    $('#leftPanelMenu').css('top','0px');
    $('#leftPanelMenu').css('height','0px');
    $('#panelToggle').css('left','0px');
    $('#panelToggle').css('height','0px');
    $('#pageContentDiv').css('top','0px');
    $('#pageContentDiv').css('left','0px');
    $('.compass_ctn').css('width','0px');
    $('.compass_ctn').css('height','0px');
    $('.compass-ct').css('width','0px');
    $('.compass-ct').css('height','0px');
    $('#mydeskpanel').hide();
    $('#mx_divGrabber').hide();
    $('#buttonnotification').hide();
    $('.topbar-logo-large.fonticon.fonticon-3ds').hide();
    $('.compass-small').css('height','0px');
    $('.compass-small').css('width','0px');
    $('.quadrant-play-small').css('height','0px');
    $('.quadrant-play-small').css('width','0px');
    $('.compass-small-over').css('height','0px');
    $('.compass-small-over').css('width','0px');
    $('#topbar > div.topbar-right.topbar-without-extrabtn > div.topbar-menu > div.add.topbar-menu-item.topbar-cmd.enabled.fonticon.fonticon-plus').hide();
    $('#btn_tag_nav').hide();
    $('#topbar > div.topbar-right.topbar-without-extrabtn > div.topbar-menu > div.share.topbar-menu-item.topbar-cmd.enabled.fonticon.fonticon-mail-forward-alt').hide();
    $('#topbar > div.topbar-right.topbar-without-extrabtn > div.topbar-menu > div.home.topbar-menu-item.topbar-cmd.enabled.fonticon.fonticon-home-alt').hide();
    $('#topbar > div.topbar-right.topbar-without-extrabtn > div.topbar-menu > div.help.topbar-menu-item.topbar-cmd.enabled.fonticon.fonticon-question-circle').hide();
    $('#topbar > div.topbar-right.topbar-without-extrabtn > div.topbar-menu > div.profile.topbar-menu-item.topbar-cmd.enabled.fonticon.fonticon-user-alt').hide();
    $('#topbar > div.topbar-right.topbar-without-extrabtn > div.topbar-menu > div.context.topbar-menu-item.topbar-cmd.enabled.fonticon.fonticon-cloud-alt').hide();
    $('#topbar > div.topbar-center.topbar-without-extrabtn > div.topbar-cmd.fonticon.fonticon-menu.menu').hide();
    $('.topbar-logo').hide();
    $('#panelToggle').hide();
    $('#global_ctn_search').hide();
