<%-- emxJobRequestArchive.jsp
  ...
  static const char RCSID[] = $Id: emxJobRequestArchive.jsp.rca 1.1.5.4 Wed Oct 22 15:47:58 2008 przemek Experimental przemek $
--%>
...
<%
    ...
    if(checkBoxId != null )
    {
        try
        {        
            Job.archive(context, checkBoxId);
        }
        catch (Exception e)
        {  
