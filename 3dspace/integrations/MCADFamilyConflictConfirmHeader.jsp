<%--  MCADFamilyConflictConfirmHeader.jsp
...
<body>
	...
	<table border="0" width="100%" cellpadding="2">
	    <!--XSSOK-->
		<tr><td class="pageHeader"><%=integSessionData.getStringResource("mcadIntegration.Server.Title.FamilyConflictResolutionDialog")%></td></tr>
	</table>
