...
<body>
	...
	<table border="0" cellspacing="2" cellpadding="2" width="100%">
		<tr>
                        <!--XSSOK-->
			<td class="pageHeader"><%= integSessionData.getStringResource("mcadIntegration.Server.Title.Preferences")%></td>
		</tr>
	</table>
	<br>
	<table border="0" cellspacing="2" cellpadding="0" width="100%">
		<tr>
			<td align="right" >
			<a href='javascript:openIEFHelp("emxhelpdscpreferences")'><img src="./images/buttonContextHelp.gif" width="16" height="16" border="0" ></a>
			</td>
		</tr>
	</table>
