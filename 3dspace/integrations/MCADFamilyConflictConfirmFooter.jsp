<%--  MCADFamilyConflictConfirmFooter.jsp
...
<script language="javascript">
	function doDone()
	{
      var framefamilyConflictContentFrame = findFrame(top,"familyConflictContentFrame");
	  framefamilyConflictContentFrame.formSubmit();
	}
