<%--  IEFGlobalPreferencesHeader.jsp
...
<%
	...
	String pageHeader	= integSessionData.getStringResource("mcadIntegration.Server.Heading.GlobalPreferences");
%>
...
<body>
	...
	<table border="0" cellspacing="2" cellpadding="0" width="100%">
		<tr>
			<td align="right" >
			<a href='javascript:openIEFHelp("emxhelpdscgcoprefs")'><img src="./images/buttonContextHelp.gif" width="16" height="16" border="0" ></a>
			</td>
		</tr>
	</table>
