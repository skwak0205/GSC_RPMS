<%--  MCADCheckinConflictUUIDNodesHeader.jsp
...
<%
	...
	String pageTitle = integSessionData.getStringResource("mcadIntegration.Server.Title.Checkin");
	if(operationName.equals("checkin"))
		pageTitle = integSessionData.getStringResource("mcadIntegration.Server.Heading.ConflictUUID");
%>
...
<body>
	...
	<table border="0" cellspacing="2" cellpadding="2" width="100%">
		<tr>
		    <!--XSSOK-->
			<td class="pageHeader"><%= pageTitle %></td>
