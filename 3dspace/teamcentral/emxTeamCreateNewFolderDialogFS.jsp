<%--  emxTeamCreateNewFolderDialogFS.jsp   -   Create Frameset for New TopLevel Folder
   ...
   static const char RCSID[] = $Id: emxTeamCreateNewFolderDialogFS.jsp.rca 1.8 Wed Oct 22 16:06:39 2008 przemek Experimental przemek $
--%>
...
<%
  ...
  fs.useCache(false);
  String strFolderName = emxGetParameter(request, "chkItem1");

  String projectId    = emxGetParameter(request,"objectId");

  // Specify URL to come in middle of frameset
  String contentURL = "emxTeamCreateNewFolderDialog.jsp";
  ...
  contentURL += "&folderName=" + strFolderName;

  String PageHeading = "emxTeamCentral.CreateNewFolderDailog.CreateNewFolder";
