...
<%
    String STR_ALL = "all";
    String strTableID = Request.getParameter(request, "tableID");
    String strSelectedLevel = Request.getParameter(request,"Level");
	String strSelectedType = Request.getParameter(request,"Type");
    String strSelectedState = Request.getParameter(request,"State");
