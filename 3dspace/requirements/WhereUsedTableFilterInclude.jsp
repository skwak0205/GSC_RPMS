...
String STR_LEVEL_ONE = EnoviaResourceBundle.getProperty(context, bundle, context.getLocale(), "emxRequirements.WhereUsed.LevelOne"); 
String STR_ALL = EnoviaResourceBundle.getProperty(context, bundle, context.getLocale(), "emxRequirements.Filter.All");
...
<script language="javascript">
	...
	<form name="filterIncludeForm">
		<table border="0" cellspacing="2" cellpadding="3" >
		  ...
		  <!--Code to populate "Level" combobox on the filter bar -->
			   <td  width="90" bgColor=#e2e2e2 fontsize ><b>
				  <emxUtil:i18n localize="i18nId">
					emxRequirements.Form.Label.Show
				  </emxUtil:i18n></b>
			   </td>
			   <td width="80" bgcolor="#cccccc"><b>
				  <emxUtil:i18n localize="i18nId">
					emxRequirements.Form.Label.Level
				  </emxUtil:i18n></b>
			   </td>
			   <td class="inputField" colspan="1">
					<select name="Level">
					  <option value="1">
						  <xss:encodeForHTML><%=STR_LEVEL_ONE%></xss:encodeForHTML>
					  </option>
					  <option value="all" selected>
						  <xss:encodeForHTML><%=STR_ALL%></xss:encodeForHTML>
					  </option>
					</select>
			   </td>
		 <!--Code to populate "Type" combobox on the filter bar -->
			   <td  width="80" bgcolor="#cccccc"><b>
				...
				<td class="inputField" colspan="1">
					<select name="Type">
					  <option value="all" selected ><xss:encodeForHTML><%=STR_ALL%></xss:encodeForHTML></option>
			 <%
		...
		%>
							  ...
							  <xss:encodeForHTML><%=(String)filterColumnValuesMap.get(slFilterValuesMapList.elementAt(i))%></xss:encodeForHTML>
							  </option>
		<%
					   }
		%>
		...
		%>
			   ...
			   <td width="90"><input type="button" id="btnFilter" value="<emxUtil:i18n  localize="i18nId">emxRequirements.Button.Filter</emxUtil:i18n>"
