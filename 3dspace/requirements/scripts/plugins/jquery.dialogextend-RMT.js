...
/*
 * @quickreview HAT1 ZUD 16:06:14  IR-437663-3DEXPERIENCER2017x: Please translate the word of some tooltips into Japanese version 2.
 * 
 * */
  ...
  $.widget("ui.dialogExtend", {
    ...
    _initButtons: function() {
      ...
      titlebar.find(".ui-dialog-titlebar-close").css({
        ...
        "right": "auto",
        "margin": 0
      }).find(".ui-icon").removeClass("ui-icon-closethick").addClass(this.options.icons.close).end().appendTo(buttonPane).end();                                  //HAT1 ZUD IR-437663-3DEXPERIENCER2017x: fix      
      buttonPane.append('<a class="ui-dialog-titlebar-restore ui-corner-all ui-state-default" href="#"><span class="ui-icon ' + this.options.icons.restore + '" title="' + strRestore + '">restore</span></a>').find('.ui-dialog-titlebar-restore').attr("role", "button").mouseover(function() {
    ...
    _initModuleButton: function(name, mode) {
      ...
      // ++ HAT1 ZUD IR-437663-3DEXPERIENCER2017x fix
      var name_lg = name;
      if(name == "maximize")
    	  name_lg = strMaximize;
	  	  ...
	  	  name_lg = strMinimize;
      // -- HAT1 ZUD IR-437663-3DEXPERIENCER2017x fix 
      return buttonPane.append('<a class="ui-dialog-titlebar-' + name + ' ui-corner-all ui-state-default" href="#" title="' + name_lg + '"><span class="ui-icon ' + this.options.icons[name] + '">' + name + '</span></a>').find(".ui-dialog-titlebar-" + name).attr("role", "button").mouseover(function() {
        return $(this).addClass("ui-state-hover");
      }).mouseout(function() {
        return $(this).removeClass("ui-state-hover");
      }).focus(function() {
