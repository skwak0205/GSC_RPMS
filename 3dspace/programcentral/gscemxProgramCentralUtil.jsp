...
<script language="javascript">
  if(parent.emxEditableTable.checkDataModified()){
    ...
    //modified by jrchoi 230308
    if(top.showSlideInDialog) top.showSlideInDialog(url,true);
    else parent.parent.parent.showSlideInDialog(url,true);
  }
</script>
<%
  }
...
<%
  ...
  // HJ Table 변경
  // People 조회 Table PMCProjectPeople을 gscPMCProjectPeople 로 Table 변경에 따른 strURL 수정
  ...
  //String strURL = "../common/emxIndentedTable.jsp?program=emxDomainAccess:getObjectAccessList&table=gscPMCProjectPeople&toolbar=PMCMemberSummaryToolBar&header=emxProgramCentral.Common.Members&HelpMarker=emxhelpprojectmembers&editRootNode=false&objectBased=false&hideRootSelection=true&displayView=details&showClipboard=false&HelpMarker=emxhelpmultipleownershipaccess&massUpdate=false&selection=multiple&Export=false&sortColumnName=Name&sortDirection=ascending&isViewMode=true&level=0&expandLevelFilter=true&freezePane=Project,Organization&massUpdate=true&persistent=false&showRMB=false&parallelLoading=true&maxCellsToDraw=2000&scrollPageSize=50";
