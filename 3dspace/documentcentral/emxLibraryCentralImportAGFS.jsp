...
<%
	...
	String PageHeading = "emxMultipleClassification.Command.ImportHeading";
	String HelpMarker = "emxhelpimportattribgroup";
	String contentURL = "emxLibraryCentralImportAG.jsp";
	...
	if(!UIUtil.isNullOrEmpty(heading))
		PageHeading ="emxMultipleClassification.Command.ImportHeadingBkg";
