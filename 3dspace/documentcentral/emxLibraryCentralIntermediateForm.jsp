...
<%
    try
    {
        ...
        if(mode != null && !"null".equals(mode) && ("copy".equalsIgnoreCase(mode)|| "revise".equalsIgnoreCase(mode))) {
            ...
            } else if (domObj.isKindOf(context, LibraryCentralConstants.TYPE_GENERIC_DOCUMENT)){//Generic Document IR-661760-3DEXPERIENCER2020x
            ...
            if("revise".equalsIgnoreCase(mode)) {
                ...
                } else if (domObj.isKindOf(context, LibraryCentralConstants.TYPE_GENERIC_DOCUMENT)){//IR-661760-3DEXPERIENCER2020x
            ...
            contentURL.append("&typeChooser=true&nameField=autoName");
