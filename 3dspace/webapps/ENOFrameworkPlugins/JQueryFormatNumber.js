...
var testVariable = 'jQuery.formatNumber';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOFrameworkPlugins/JQueryFormatNumber';   //name of the shym module
var VenModuleName = 'jquery.formatNumber';        //name of the vendor module
var VenMWebName = 'DS/VENENOFrameworkPlugins/';                 //name of the vendor mweb
var folderPath = 'jquery-numberformatter/'
...
var jsName = 'jquery-numberformatter';             //name of the js to load (to verify if the shim has already been configured.  Should not be the same as VenModuleName)
var deps = ['DS/ENOFrameworkPlugins/jQuery','DS/ENOFrameworkPlugins/JSHashTable'];
