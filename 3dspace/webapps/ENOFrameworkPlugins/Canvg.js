...
var testVariable = 'canvg';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOFrameworkPlugins/Canvg';   //name of the shym module
var VenModuleName = 'canvg';        //name of the vendor module
var VenMWebName = 'DS/VENENOFrameworkPlugins/';                 //name of the vendor mweb
var folderPath = 'jscanvg/'
...
var jsName = 'jscanvg';             //name of the js to load (to verify if the shim has already been configured.  Should not be the same as VenModuleName)
var deps = [];
