...
if (require.toUrl('DS/VENENOFrameworkPlugins/Fancytree_contextMenu').indexOf('latest') === -1) { //if we don't have latest in the path for the module
    ...
    require.config({
        paths: {
            'DS/VENENOFrameworkPlugins/Fancytree_contextMenu': lFancytreePath + 'jquery.fancytree.contextmenu'
        },
        shim: {
            'DS/VENENOFrameworkPlugins/Fancytree_contextMenu': {
...
define('DS/ENOFrameworkPlugins/Fancytree_contextMenu', ['DS/VENENOFrameworkPlugins/Fancytree_contextMenu'], function (contextMenu) {
    'use strict';
    return contextMenu;
});
