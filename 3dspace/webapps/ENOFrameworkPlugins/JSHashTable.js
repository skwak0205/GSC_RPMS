...
var testVariable = 'Hashtable';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOFrameworkPlugins/JSHashTable';   //name of the shym module
var VenModuleName = 'HashTable';        //name of the vendor module
var VenMWebName = 'DS/VENENOFrameworkPlugins/';                 //name of the vendor mweb
var folderPath = 'jshashtable/'
...
var jsName = 'jshashtable';             //name of the js to load (to verify if the shim has already been configured.  Should not be the same as VenModuleName)
var deps = [];
