...
//-------------------------------------------------------------------------
//IR-942151-3DEXPERIENCER2022x - Commenting out the setExpand for parents
//this happens automatically on make visible, which is undesirable
//it turns on nodes in the tree that have been hidden by default and causes problems with status filters
		//for(i = len - 1; i >= 0; i--){
...
//			this._fixSelectionState(node);
	...
	//            $().addClass("ui-helper-hidden");
		...
		dfd = this.nodeLoadChildren(rootCtx, source).done(function(){
			// IR-719052 Set 'deep = true', to create 3D Part nodes, but parent is not expanded
			tree.render(undefined, ctx.options.deep);
