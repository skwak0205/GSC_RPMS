...
Ext.define('Gnt.locale.En', {
    ...
    l10n        : {
        ...
        'Gnt.column.Baseline Initial Start Date'   : {
            text            : 'Baseline Initial Start Date'
        },
        'Gnt.column.Baseline Initial Finish Date'   : {
            text            : 'Baseline Initial Finish Date'
        },
        'Gnt.column.Baseline Current Start Date'   : {
            text            : 'Baseline Current Start Date'
        },
        'Gnt.column.Baseline Current Finish Date'   : {
            text            : 'Baseline Current Finish Date'
        },
