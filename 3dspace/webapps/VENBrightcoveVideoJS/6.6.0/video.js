...
var Component = function () {
  ...
  Component.prototype.setTimeout = function setTimeout(fn, timeout) {
    ...
    var timeoutId = window_1.setTimeout(function() {
      if (_this2.player_ && _this2.el_) {
        fn();
      }
    }, timeout);
  ...
  Component.prototype.setInterval = function setInterval(fn, interval) {
    ...
    var intervalId = window_1.setInterval(function() {
      if (_this3.player_ && _this3.el_) {
        fn();
      }
    }, interval);
  ...
  Component.prototype.requestAnimationFrame = function requestAnimationFrame(fn) {
    ...
    if (this.supportsRaf_) {
      ...
      var id = window_1.requestAnimationFrame(function(ts) {
        if(_this4.player_ /**&& this._el**/) {
          fn(ts);
        }
      });
      return id;
...
var specApi = apiMap[4]; //the spec api name is moved to 4th element
...
//only IOS safari does not support requestfullscreen.. https://caniuse.com/#feat=fullscreen
if (browserApi && !IS_IOS) {
...
var loadTrack = function loadTrack(src, track) {
  ...
  if (crossOrigin) {
    ...
    //when loading tracks use credentials if required
    if (track && track.tech_ && track.tech_.el_ && track.tech_.el_.getAttribute('crossoriginvjs') === 'use-credentials') {
...
var TextTrackDisplay = function (_Component) {
  ...
  */
  ...
  TextTrackDisplay.prototype.updateForTrack = function updateForTrack(track) {
    ...
    var overrides = this.player_.textTrackSettings ? this.player_.textTrackSettings.getValues() : {};
    var cues = [];
...
var Player = function (_Component) {
  ...
  Player.prototype.requestFullscreen = function requestFullscreen() {
    ...
    if (fsApi.requestFullscreen) {
      ...
      //here we have to take care of the fullscreen even if in 3DD -_-' or an iframe that does not have the allowfullscreen as attribute...
      on(document_1, fsApi.fullscreenerror, bind(this, function documentFullscreenError(e) {
        console.log('Error detected while trying to use HTML5 fullscreen');
        fsApi.requestFullscreen = null; //flag native fullscreen as impossible so that in exiting fullscreen we use the proper exit
        //now try fake fullscreen ...
