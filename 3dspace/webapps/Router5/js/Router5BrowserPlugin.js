define('DS/Router5/js/Router5BrowserPlugin', [], function () {
    'use strict';
...
function browserPluginFactory() {
    ...
    function browserPlugin(router) {
        ...
        function onPopState(evt) {
        	if(router._isReadyToNavigate != undefined && !router._isReadyToNavigate){
        		console.log('Can not navigate');
        		var state = browser.getState();
        		var url = browser.getBase();
        		browser.pushState(state, '',url);
        	}else{
