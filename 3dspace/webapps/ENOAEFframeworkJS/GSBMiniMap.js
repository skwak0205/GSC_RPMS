...
var testVariable = 'swv6.ui.MiniMap';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/GSBMiniMap';   //name of the shym module
var VenModuleName = 'MiniMap';        //name of the vendor module
