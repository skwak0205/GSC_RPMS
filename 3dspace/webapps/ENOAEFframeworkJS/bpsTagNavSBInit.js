...
var testVariable = 'bpsTagNavSBInit';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/bpsTagNavSBInit';   //name of the shym module
var VenModuleName = 'bpsTagNavSBInit';        //name of the vendor module
