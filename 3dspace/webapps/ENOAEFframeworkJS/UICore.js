...
var testVariable = 'emxUICore';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/UICore';   //name of the shym module
var VenModuleName = 'emxUICore';        //name of the vendor module
...
var deps = ['DS/ENOAEFframeworkJS/UIConstants'];       //dependencies
