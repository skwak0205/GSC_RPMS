...
var testVariable = 'swv6.util';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/GSBUtil';   //name of the shym module
var VenModuleName = 'util';        //name of the vendor module
