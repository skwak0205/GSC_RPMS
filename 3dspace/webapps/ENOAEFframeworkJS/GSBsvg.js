...
var testVariable = 'swv6.svg.SVG';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/GSBsvg';   //name of the shym module
var VenModuleName = 'svg';        //name of the vendor module
