...
var testVariable = 'bpsSBFilter';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/bpsSBFilter';   //name of the shym module
var VenModuleName = 'bpsSBFilter';        //name of the vendor module
