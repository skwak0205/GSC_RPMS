...
var testVariable = 'bpsTagNavConnector';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/UITagNavConnector';   //name of the shym module
var VenModuleName = 'bpsTagNavConnector';        //name of the vendor module
