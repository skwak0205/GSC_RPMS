...
var testVariable = 'emxFindInCntrl';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/FindInCntrl';   //name of the shym module
var VenModuleName = 'emxFindInCntrl';        //name of the vendor module
