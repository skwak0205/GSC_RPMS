...
var testVariable = 'swv6.sample.Controller';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/GSBController';   //name of the shym module
var VenModuleName = 'Controller';        //name of the vendor module
...
var deps = ['DS/ENOAEFframeworkJS/GSBUtil','DS/ENOAEFframeworkJS/GSBCoreController','DS/ENOAEFframeworkJS/GSBNodeDragManager'];
