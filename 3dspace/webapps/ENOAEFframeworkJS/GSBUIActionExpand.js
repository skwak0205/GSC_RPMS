...
var testVariable = 'swv6.ui.Action.Expand';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/GSBUIActionExpand';   //name of the shym module
var VenModuleName = 'UIActionExpand';        //name of the vendor module
...
var deps = ['DS/ENOAEFframeworkJS/GSBUIActionCameraLayout'];
