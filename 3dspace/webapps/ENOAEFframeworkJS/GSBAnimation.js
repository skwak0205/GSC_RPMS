...
var testVariable = 'swv6.animation.animation';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/GSBAnimation';   //name of the shym module
var VenModuleName = 'animation';        //name of the vendor module
...
var jsName = 'actions';             //name of the js to load (to verify if the shim has already been configured.  Should not be the same as VenModuleName)
