...
var testVariable = 'emxExtendedPageHeaderFreezePaneValidation';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/ExtendedPageHeaderFreezePaneValidation';   //name of the shym module
var VenModuleName = 'emxExtendedPageHeaderFreezePaneValidation';        //name of the vendor module
