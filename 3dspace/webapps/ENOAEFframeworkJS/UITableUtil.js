...
var testVariable = 'emxUITableUtil';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/UITableUtil';   //name of the shym module
var VenModuleName = 'emxUITableUtil';        //name of the vendor module
