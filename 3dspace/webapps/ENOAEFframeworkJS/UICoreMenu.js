...
var testVariable = 'emxUICoreMenu';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/UICoreMenu';   //name of the shym module
var VenModuleName = 'emxUICoreMenu';        //name of the vendor module
...
var deps = ['DS/ENOAEFframeworkJS/UICore'];
