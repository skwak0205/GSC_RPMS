...
var testVariable = 'emxUIRTE';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/UIRTE';   //name of the shym module
var VenModuleName = 'emxUIRTE';        //name of the vendor module
