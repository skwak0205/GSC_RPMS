...
var testVariable = 'enoJSValidationUtil';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/JSValidationUtil';   //name of the shym module
var VenModuleName = 'enoJSValidationUtil';        //name of the vendor module
