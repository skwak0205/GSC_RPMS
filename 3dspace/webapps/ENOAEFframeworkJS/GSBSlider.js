...
var testVariable = 'swv6.ui.Slider';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/GSBSlider';   //name of the shym module
var VenModuleName = 'slider';        //name of the vendor module
