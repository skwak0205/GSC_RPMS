...
var testVariable = 'emxUIFreezepaneEdit';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/UIFreezePaneEdit';   //name of the shym module
var VenModuleName = 'emxUIFreezePaneEdit';        //name of the vendor module
...
var deps = ['DS/ENOAEFframeworkJS/UIFreezePane'];
