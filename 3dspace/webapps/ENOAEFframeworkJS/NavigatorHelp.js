...
var testVariable = 'emxNavigatorHelp';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/NavigatorHelp';   //name of the shym module
var VenModuleName = 'emxNavigatorHelp';        //name of the vendor module
