...
var testVariable = 'rte_toolbar';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/UIRTEToolbar';   //name of the shym module
var VenModuleName = 'emxUIRTEToolbar';        //name of the vendor module
