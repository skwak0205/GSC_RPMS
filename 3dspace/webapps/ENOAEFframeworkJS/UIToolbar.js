...
var testVariable = 'emxUIToolbar';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/UIToolbar';   //name of the shym module
var VenModuleName = 'emxUIToolbar';        //name of the vendor module
...
var deps = ['DS/ENOAEFframeworkJS/UICoreMenu'];
