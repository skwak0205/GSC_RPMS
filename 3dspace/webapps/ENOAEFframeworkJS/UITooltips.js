...
var testVariable = 'emxUITooltips';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/UITooltips';   //name of the shym module
var VenModuleName = 'emxUITooltips';        //name of the vendor module
