...
var testVariable = 'emxUIPopups';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/UIPopups';   //name of the shym module
var VenModuleName = 'emxUIPopups';        //name of the vendor module
