...
var testVariable = 'swv6.util.Deferred';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/GSBDeferred';   //name of the shym module
var VenModuleName = 'Deferred';        //name of the vendor module
...
var deps = ['DS/ENOAEFframeworkJS/GSBCallbacks'];
