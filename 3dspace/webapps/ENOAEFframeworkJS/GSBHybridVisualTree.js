...
var testVariable = 'swv6.ui.HybridVisualTree';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/GSBHybridVisualTree';   //name of the shym module
var VenModuleName = 'HybridVisualTree';        //name of the vendor module
var VenMWebName = 'DS/VENENOFrameworkPlugins/';                 //name of the vendor mweb
var folderPath = 'GraphicalSB/'
...
var jsName = 'GraphicalSB';             //name of the js to load (to verify if the shim has already been configured.  Should not be the same as VenModuleName)
var deps = ['DS/ENOAEFframeworkJS/GSBUtil','DS/ENOAEFframeworkJS/GSBsvg','DS/ENOAEFframeworkJS/GSBVisualTree'];
