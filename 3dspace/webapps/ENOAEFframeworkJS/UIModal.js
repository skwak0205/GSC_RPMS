...
var testVariable = 'emxUIModalDialog';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/UIModal';   //name of the shym module
var VenModuleName = 'emxUIModal';        //name of the vendor module
