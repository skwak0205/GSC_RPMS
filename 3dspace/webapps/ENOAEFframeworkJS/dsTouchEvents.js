...
var testVariable = 'touchHandler';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/dsTouchEvents';   //name of the shym module
var VenModuleName = 'dsTouchEvents';        //name of the vendor module
