...
var testVariable = 'Query';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/Query';   //name of the shym module
var VenModuleName = 'emxQuery';        //name of the vendor module
