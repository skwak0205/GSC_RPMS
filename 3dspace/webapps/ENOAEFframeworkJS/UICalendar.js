...
var testVariable = 'emxUICalendar';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/UICalendar';   //name of the shym module
var VenModuleName = 'emxUICalendar';        //name of the vendor module
...
var deps = ['DS/ENOAEFframeworkJS/UICore','DS/ENOAEFframeworkJS/UICoreMenu'];
