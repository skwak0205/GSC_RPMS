...
var testVariable = 'swv6.html';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/GSBhtml';   //name of the shym module
var VenModuleName = 'html';        //name of the vendor module
