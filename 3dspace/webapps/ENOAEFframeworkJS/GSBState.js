...
var testVariable = 'swv6.ui.State';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/GSBState';   //name of the shym module
var VenModuleName = 'State';        //name of the vendor module
