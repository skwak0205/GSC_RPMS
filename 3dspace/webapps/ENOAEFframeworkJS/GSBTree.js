...
var testVariable = 'swv6.data.Tree';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/GSBTree';   //name of the shym module
var VenModuleName = 'Tree';        //name of the vendor module
