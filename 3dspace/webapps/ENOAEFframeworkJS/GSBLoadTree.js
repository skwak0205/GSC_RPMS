...
var testVariable = 'swv6.sample.Action.LoadTree';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/GSBLoadTree';   //name of the shym module
var VenModuleName = 'LoadTree';        //name of the vendor module
...
var deps = ['DS/ENOAEFframeworkJS/GSBUtil','DS/ENOAEFframeworkJS/GSBActionsLoadTree'];
