...
var testVariable = 'swv6.util.Callbacks';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/GSBCallbacks';   //name of the shym module
var VenModuleName = 'Callbacks';        //name of the vendor module
