...
var testVariable = 'TypeAhead';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/TypeAhead';   //name of the shym module
var VenModuleName = 'emxTypeAhead';        //name of the vendor module
