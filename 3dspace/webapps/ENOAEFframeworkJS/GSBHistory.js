...
var testVariable = 'swv6.ui.History';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/GSBHistory';   //name of the shym module
var VenModuleName = 'History';        //name of the vendor module
