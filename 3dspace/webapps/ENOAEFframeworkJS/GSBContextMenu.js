...
var testVariable = 'swv6.ui.ContextMenu';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/GSBContextMenu';   //name of the shym module
var VenModuleName = 'ContextMenu';        //name of the vendor module
...
var deps = ['DS/ENOAEFframeworkJS/GSBUtil'];
