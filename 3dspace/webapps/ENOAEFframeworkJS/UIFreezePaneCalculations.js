...
var testVariable = 'calculatedRowsObject';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/UIFreezePaneCalculations';   //name of the shym module
var VenModuleName = 'emxUIFreezePaneCalculations';        //name of the vendor module
