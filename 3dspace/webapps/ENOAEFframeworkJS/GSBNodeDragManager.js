...
var testVariable = 'swv6.sp.NodeDragManager';  //name of the variable used to verify if the module is loaded and to export
var ShimModuleName = 'DS/ENOAEFframeworkJS/GSBNodeDragManager';   //name of the shym module
var VenModuleName = 'NodeDragManager';        //name of the vendor module
