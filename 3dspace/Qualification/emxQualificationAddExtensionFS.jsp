...
<%
  ...
  String targetLoc =  emxGetParameter(request, "targetLocation");
  /* 
  ...
  String contentURL = "emxQualificationAddExtension.jsp";
  contentURL += "?mode=edit";
  contentURL += "&suiteKey=" + suiteKey + "&objectId=" +  objectId ;
  contentURL += "&targetLocation=" + targetLoc;
 ...
 //System.out.println("YI3 - URL :" + contentURL);
  ...
  //BMN2 22/09/2017 : IR-506065
  String HelpMarker = "emxhelpcustomerextadd";
  String formHeader = EnoviaResourceBundle.getProperty(context, "emxQualificationStringResource", context.getLocale(), "emxQualification.label.AddExtensionCmd");
