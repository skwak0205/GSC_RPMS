<%--
  emxComponentsSelectRegionDialogFS.jsp -  This page is the Frame page to select Regions.
  ...
  static const char RCSID[] = $Id: emxComponentsSelectRegionDialogFS.jsp.rca 1.13 Wed Oct 22 16:18:28 2008 przemek Experimental przemek $
--%>
...
<%
    ...
    buffer.append("header=emxComponentsCentral.Common.SelectRegion").append('&');
    ...
    buffer.append("expandProgram=emxRegion:selectionRegionExpandProgram").append('&');
