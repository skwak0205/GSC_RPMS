...
<script language="javascript">
	...
	if(typeof oXML != 'undefined' && oXML != null) {
		...
		document.location.href = "../components/emxLaunch3DLiveExamineCheck.jsp?3DCompare=true&objectId1="+objectId1+"&objectId2="+objectId2;
	} else {
		alert("<emxUtil:i18nScript localize="i18nId">emxComponents.3DLiveExamine.NoCompareResultsFound</emxUtil:i18nScript>");
	}
</script>
</head>
