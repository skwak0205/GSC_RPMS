<%--
   emxComponentsPotentialSuppliersSearchResultsFS.jsp -
   ...
   static const char RCSID[] = $Id: emxComponentsPotentialSuppliersSearchResultsFS.jsp.rca 1.8 Wed Oct 22 16:18:43 2008 przemek Experimental przemek $
--%>
<jsp:useBean id="emxComponentsPotentialSuppliersSearchResultsFS" class="com.matrixone.apps.framework.ui.UITable" scope="session" />

<%@include file="../emxUIFramesetUtil.inc"%>
<%@include file="emxComponentsFramesetUtil.inc"%>

<%
  String tableBeanName = "emxComponentsPotentialSuppliersSearchResultsFS";
  ...
  String contentURL = "emxComponentsPotentialSuppliersSearchResults.jsp";
