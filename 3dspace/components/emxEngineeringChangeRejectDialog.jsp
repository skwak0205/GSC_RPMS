<%--  emxEngineeringChangeRejectDialog.jsp
  ...
  static const char RCSID[] = "$Id: emxEngineeringChangeRejectDialog.jsp.rca 1.5 Wed Oct 22 16:18:19 2008 przemek Experimental przemek $";
...
<form name = "EngineeringChangeReject" action = "" method = "post">
    ...
    <tr>
        <td width="150" class="labelRequired">
            <framework:i18n localize="i18nId"><%="emxFramework.Attribute.Reason_For_Rejection"%></framework:i18n>
        </td>
        <td class="field">
            <textarea name="txtECReasonForRejection" rows="5" cols="25"></textarea>
        </td>
    </tr>
...
<script language="javascript" type="text/javaScript">
    var  formname = document.EngineeringChangeReject;
    ...
    function validateForm()
    {
        ...
        //Validation for Required field Reason for Rejection
        if (iValidForm)
        {
            var fieldName = "<%=XSSUtil.encodeForJavaScript(context, i18nNow.getI18nString("emxFramework.Attribute.Reason_For_Rejection", bundle,acceptLanguage))%> ";
            var field = formname.txtECReasonForRejection;
    ...
    //when Done button is pressed in Reject Dialog Page
    function submit()
    {
        strURL = "emxEngineeringChangeUtil.jsp?mode=reject";
