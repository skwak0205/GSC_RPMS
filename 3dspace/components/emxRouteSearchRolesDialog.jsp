<%-- emxRoutesSearchRolesDialog.jsp --
  ...
  Copyright notice is precautionary only and does not evidence any actual or intended publication of such program
   ...
   static const char RCSID[] = $Id: emxRouteSearchRolesDialog.jsp.rca 1.17 Wed Oct 22 16:18:54 2008 przemek Experimental przemek $
--%>
...
<form name="searchtemplate" id="searchtemplate" method="post" onSubmit="javascript:doSearch(); return false" target="_parent" action="emxRouteSearchRolesResultsFS.jsp">
  ...
  <table border="0" cellpadding="5" cellspacing="2" width="530">
    ...
    <tr>
      ...
      <td class="inputField">
        <input type="text" name="txtName" id="txtName" value="<%=XSSUtil.encodeForHTML(context, sName)%>"/>
      </td>
    </tr>
    <tr>
      <td class="label">
      ...
      <td class="inputField">
        <table>
          <tr><td>
            <input type="checkbox" name="chkTopLevel" id="chkTopLevel" value="Checked" <%=XSSUtil.encodeForHTML(context, sTopChecked)%>/><emxUtil:i18n localize="i18nId">emxComponents.SearchRole.TopLevel</emxUtil:i18n>
          </td></tr>
          <tr><td>
            <input type="checkbox" name="chkSubLevel" id="chkSubLevel" value="Checked" <%=XSSUtil.encodeForHTML(context, sSubChecked)%>/><emxUtil:i18n localize="i18nId">emxComponents.SearchRole.SubLevel</emxUtil:i18n>
          </td></tr>
        </table>
      </td>
    </tr>
