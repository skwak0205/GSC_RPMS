<%-- emxComponentsSearchGroupsResultsFS.jsp -- Frameset for Role Search Result page
  Copyright (c) 1992-2020 Dassault Systemes.
  All Rights Reserved.
  This program contains proprietary and trade secret information of MatrixOne, Inc.
  Copyright notice is precautionary only and does not evidence any actual or intended publication of such program

  static const char RCSID[] = $Id: emxComponentsSearchGroupsResultsFS.jsp.rca 1.6 Wed Oct 22 16:18:27 2008 przemek Experimental przemek przemek $
--%>

<%@include file  = "../emxUIFramesetUtil.inc"%>
<%@include file = "emxRouteInclude.inc"%>

<jsp:useBean id="emxComponentsSearchGroupsResultsFS" class="com.matrixone.apps.framework.ui.UITable" scope="session" />
...
<%
  ...
  String tableBeanName    = "emxComponentsSearchGroupsResultsFS";
  ...
  {
      PageHeading = "emxComponents.SearchGroup.SearchGroups";
  }
  ...
  contentURL.append("emxComponentsSearchGroupsResults.jsp");
