...
%>
              <input type="hidden" name="<%=XSSUtil.encodeForHTMLAttribute(context,name)%>" value="<%=XSSUtil.encodeForHTMLAttribute(context, (String)value)%>" />
<%
          }
%>
            </table>
...
%>
 ...
 <frameset rows="78,*,1,50" frameborder="no" framespacing="0">
  ...
  <frame name="checkinFrame"       src="emxCommonDocumentUpdateAppletDialog.jsp" marginwidth="0" marginheight="0" frameborder="no" scrolling="no">
  <frame name="checkinHiddenFrame" src="emxCommonDocumentUpdateAppletHiddenDialog.jsp" marginwidth="0" marginheight="0" frameborder="no" scrolling="no">
