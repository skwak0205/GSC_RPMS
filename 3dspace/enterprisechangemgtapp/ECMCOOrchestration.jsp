...
<script>
    ...
    function loadCOOrchestrationContent(){
        ...
        function(PlatformAPI, CASpinner,ChgInfraService,ChgServiceGlobalVariable, ChgDataService, ModelEvents, ChgOrchestrationDataGridLayout,ChgCustomAttributeService){
