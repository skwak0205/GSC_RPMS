...
<script>
    ...
    function loadCROrchestrationContent(){
        ...
        function(PlatformAPI, CASpinner,ChgInfraService,ChgServiceGlobalVariable, ChgDataService, ModelEvents, ChgCROrchestrationDataGridLayout,ChgCustomAttributeService){
