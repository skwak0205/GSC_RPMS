...
//    'use strict';
    ...
    CLASS =
        ...
        function (config) {
            ...
            // load up the new data tree or refresh existing data, subclass overload with options
            this.newTree = this.loadDataTree(config.options);
