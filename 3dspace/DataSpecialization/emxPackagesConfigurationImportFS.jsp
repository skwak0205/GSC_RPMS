...
<%
  ...
  fs.setDirectory("DataSpecialization");
  ...
  String formHeader = DAuUtilities.getSpecializationStringResource(context,"emxDataSpecialization.label.PackageImportTitle");
  fs.initFrameset(formHeader,HelpMarker,contentURL,false,true,false,false);
  fs.setStringResourceFile("emxDataSpecializationStringResource");
  ...
  fs.createFooterLink("emxDataSpecialization.label.PackageImportFileSubmit","submitForm()",roleList,false,true,"emxUIButtonDone.gif",0);
  //fs.createFooterLink("emxFramework.Command.Cancel","parent.window.close()",roleList,false,true,"emxUIButtonCancel.gif",0);
  fs.createFooterLink("emxDataSpecialization.label.PackageImportCancel","top.closeSlideInDialog()",roleList,false,true,"emxUIButtonCancel.gif",0);
