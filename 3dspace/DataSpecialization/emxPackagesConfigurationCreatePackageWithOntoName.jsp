<%--  emxPackagesConfigurationCreatePackageWithOntoName.jsp
   ...
   static const char RCSID[] = $Id: emxPackagesConfigurationCreatePackageWithOntoName.jsp.rca 1.1 Wed Jan 14 05:57:06 2009 ds-smourougayan Experimental przemek $
--%>
...
private static String computeName(Context iContext, String iObjectId)
{
	...
	{
		System.out.println("MFL - emxPackagesConfigurationCreatePackageWithOntoName - Exception : " + e.getMessage());
	}
...
/*System.out.println("MFL - Create Package With OntoName property - hashMap");
...
for(int i=0;i<emxTableRowId.length;i++){
	...
	//System.out.println("MFL - Selected parent package :" + strContextObjectName); 
